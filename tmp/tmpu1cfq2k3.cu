...
extern "C" __global__ void __launch_bounds__(128, 1) kernel_kernel(bfloat16_t* __restrict__ K, bfloat16_t* __restrict__ O, bfloat16_t* __restrict__ Q, bfloat16_t* __restrict__ V, int* __restrict__ cu_seqlens_k, int* __restrict__ cu_seqlens_q, int max_seqlen_q) {
  ...
  for (int i = 0; i < 32; ++i) {
    ...
    *(uint2*)(((bfloat16_t*)buf_dyn_shmem) + ((((((((((((int)threadIdx.x) & 31) >> 4) * 8192) + (i * 256)) + ((((int)threadIdx.x) >> 5) * 64)) + (((((((int)threadIdx.x) & 15) >> 3) + (i & 1)) & 1) * 32)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 1) * 4)) + 131072)) = condval;
  }
  #pragma unroll
  ...
  for (int kv_block_idx = 0; kv_block_idx < ((min(((((((int)blockIdx.x) * 128) + cu_seqlens_q[1]) + 383) - cu_seqlens_q[0]), ((cu_seqlens_k[1] + 255) - cu_seqlens_k[0])) >> 8) - 2); ++kv_block_idx) {
    ...
    for (int i_9 = 0; i_9 < 256; ++i_9) {
      float condval_1;
      if ((((((((((int)blockIdx.x) * 128) + (((i_9 & 7) >> 2) * 64)) + ((((int)threadIdx.x) >> 6) * 32)) + 32) <= ((((kv_block_idx * 256) + ((i_9 >> 3) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_9 & 1))) || ((cu_seqlens_q[1] - cu_seqlens_q[0]) <= (((((((int)blockIdx.x) * 128) + (((i_9 & 7) >> 2) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_9 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) || ((cu_seqlens_k[1] - cu_seqlens_k[0]) <= ((((kv_block_idx * 256) + ((i_9 >> 3) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_9 & 1))))) {
    ...
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_ss<128, 256, 128, 4, 1, 0, 1, 0, 128, 128, 0, 0>((&(((bfloat16_t*)buf_dyn_shmem)[131072])), (&(((bfloat16_t*)buf_dyn_shmem)[((kv_block_idx & 1) * 32768)])), (&(acc_score[0])));
    __syncthreads();
    #pragma unroll
    ...
    for (int i_13 = 0; i_13 < 4; ++i_13) {
      ...
      for (int rv = 0; rv < 64; ++rv) {
        scores_max[i_13] = max(scores_max[i_13], acc_score[((((rv & 31) * 8) + (i_13 * 2)) + (rv >> 5))]);
      }
    ...
    for (int i_17 = 0; i_17 < 4; ++i_17) {
      ...
      for (int rv_1 = 0; rv_1 < 64; ++rv_1) {
        scores_sum[i_17] = (scores_sum[i_17] + acc_score[((((rv_1 & 31) * 8) + (i_17 * 2)) + (rv_1 >> 5))]);
      }
    ...
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_rs<128, 128, 256, 4, 1, 0, 0, 0, 256, 128, 0, 0>((&(acc_score_cast[0])), (&(((bfloat16_t*)buf_dyn_shmem)[(((kv_block_idx & 1) * 32768) + 65536)])), (&(acc_output[0])));
    __syncthreads();
    #pragma unroll
  ...
  if ((129 <= (((((int)blockIdx.x) * 128) + cu_seqlens_q[1]) - cu_seqlens_q[0])) && (257 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    ...
    for (int i_22 = 0; i_22 < 256; ++i_22) {
      float condval_2;
      if ((((68 <= ((((((min(((((((int)blockIdx.x) * 128) + cu_seqlens_q[1]) + 383) - cu_seqlens_q[0]), ((cu_seqlens_k[1] + 255) - cu_seqlens_k[0])) >> 8) * 32) + (i_22 >> 3)) - ((((int)threadIdx.x) >> 6) * 4)) - (((i_22 & 7) >> 2) * 8)) - (((int)blockIdx.x) * 16))) || ((cu_seqlens_q[1] - cu_seqlens_q[0]) <= (((((((int)blockIdx.x) * 128) + (((i_22 & 7) >> 2) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_22 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) || (((cu_seqlens_k[1] + 512) - cu_seqlens_k[0]) <= (((((min(((((((int)blockIdx.x) * 128) + cu_seqlens_q[1]) + 383) - cu_seqlens_q[0]), ((cu_seqlens_k[1] + 255) - cu_seqlens_k[0])) >> 8) * 256) + ((i_22 >> 3) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_22 & 1))))) {
  ...
  if ((129 <= (((((int)blockIdx.x) * 128) + cu_seqlens_q[1]) - cu_seqlens_q[0])) && (257 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_ss<128, 256, 128, 4, 1, 0, 1, 0, 128, 128, 0, 0>((&(((bfloat16_t*)buf_dyn_shmem)[131072])), (&(((bfloat16_t*)buf_dyn_shmem)[(((min(((((((int)blockIdx.x) * 128) + cu_seqlens_q[1]) + 383) - cu_seqlens_q[0]), ((cu_seqlens_k[1] + 255) - cu_seqlens_k[0])) & 511) >> 8) * 32768)])), (&(acc_score[0])));
  }
  if ((129 <= (((((int)blockIdx.x) * 128) + cu_seqlens_q[1]) - cu_seqlens_q[0])) && (257 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    #pragma unroll
  ...
  if ((129 <= (((((int)blockIdx.x) * 128) + cu_seqlens_q[1]) - cu_seqlens_q[0])) && (257 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    ...
    for (int i_25 = 0; i_25 < 4; ++i_25) {
      ...
      for (int rv_2 = 0; rv_2 < 64; ++rv_2) {
        scores_max[i_25] = max(scores_max[i_25], acc_score[((((rv_2 & 31) * 8) + (i_25 * 2)) + (rv_2 >> 5))]);
      }
  ...
  if ((129 <= (((((int)blockIdx.x) * 128) + cu_seqlens_q[1]) - cu_seqlens_q[0])) && (257 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    ...
    for (int i_29 = 0; i_29 < 4; ++i_29) {
      ...
      for (int rv_3 = 0; rv_3 < 64; ++rv_3) {
        scores_sum[i_29] = (scores_sum[i_29] + acc_score[((((rv_3 & 31) * 8) + (i_29 * 2)) + (rv_3 >> 5))]);
      }
  ...
  if ((129 <= (((((int)blockIdx.x) * 128) + cu_seqlens_q[1]) - cu_seqlens_q[0])) && (257 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_rs<128, 128, 256, 4, 1, 0, 0, 0, 256, 128, 0, 0>((&(acc_score_cast[0])), (&(((bfloat16_t*)buf_dyn_shmem)[((((min(((((((int)blockIdx.x) * 128) + cu_seqlens_q[1]) + 383) - cu_seqlens_q[0]), ((cu_seqlens_k[1] + 255) - cu_seqlens_k[0])) & 511) >> 8) * 32768) + 65536)])), (&(acc_output[0])));
  }
  if ((-127 <= (((((int)blockIdx.x) * 128) + cu_seqlens_q[1]) - cu_seqlens_q[0])) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    #pragma unroll
    for (int i_33 = 0; i_33 < 256; ++i_33) {
      float condval_3;
      if ((((36 <= ((((((min(((((((int)blockIdx.x) * 128) + cu_seqlens_q[1]) + 383) - cu_seqlens_q[0]), ((cu_seqlens_k[1] + 255) - cu_seqlens_k[0])) >> 8) * 32) + (i_33 >> 3)) - ((((int)threadIdx.x) >> 6) * 4)) - (((i_33 & 7) >> 2) * 8)) - (((int)blockIdx.x) * 16))) || ((cu_seqlens_q[1] - cu_seqlens_q[0]) <= (((((((int)blockIdx.x) * 128) + (((i_33 & 7) >> 2) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_33 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) || (((cu_seqlens_k[1] + 256) - cu_seqlens_k[0]) <= (((((min(((((((int)blockIdx.x) * 128) + cu_seqlens_q[1]) + 383) - cu_seqlens_q[0]), ((cu_seqlens_k[1] + 255) - cu_seqlens_k[0])) >> 8) * 256) + ((i_33 >> 3) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_33 & 1))))) {
  ...
  if ((-127 <= (((((int)blockIdx.x) * 128) + cu_seqlens_q[1]) - cu_seqlens_q[0])) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_ss<128, 256, 128, 4, 1, 0, 1, 0, 128, 128, 0, 0>((&(((bfloat16_t*)buf_dyn_shmem)[131072])), (&(((bfloat16_t*)buf_dyn_shmem)[((((min(((((((int)blockIdx.x) * 128) + cu_seqlens_q[1]) + 383) - cu_seqlens_q[0]), ((cu_seqlens_k[1] + 255) - cu_seqlens_k[0])) >> 8) + 1) & 1) * 32768)])), (&(acc_score[0])));
  }
  if ((-127 <= (((((int)blockIdx.x) * 128) + cu_seqlens_q[1]) - cu_seqlens_q[0])) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    #pragma unroll
  ...
  if ((-127 <= (((((int)blockIdx.x) * 128) + cu_seqlens_q[1]) - cu_seqlens_q[0])) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    ...
    for (int i_36 = 0; i_36 < 4; ++i_36) {
      ...
      for (int rv_4 = 0; rv_4 < 64; ++rv_4) {
        scores_max[i_36] = max(scores_max[i_36], acc_score[((((rv_4 & 31) * 8) + (i_36 * 2)) + (rv_4 >> 5))]);
      }
  ...
  if ((-127 <= (((((int)blockIdx.x) * 128) + cu_seqlens_q[1]) - cu_seqlens_q[0])) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    ...
    for (int i_40 = 0; i_40 < 4; ++i_40) {
      ...
      for (int rv_5 = 0; rv_5 < 64; ++rv_5) {
        scores_sum[i_40] = (scores_sum[i_40] + acc_score[((((rv_5 & 31) * 8) + (i_40 * 2)) + (rv_5 >> 5))]);
      }
  ...
  if ((-127 <= (((((int)blockIdx.x) * 128) + cu_seqlens_q[1]) - cu_seqlens_q[0])) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_rs<128, 128, 256, 4, 1, 0, 0, 0, 256, 128, 0, 0>((&(acc_score_cast[0])), (&(((bfloat16_t*)buf_dyn_shmem)[(((((min(((((((int)blockIdx.x) * 128) + cu_seqlens_q[1]) + 383) - cu_seqlens_q[0]), ((cu_seqlens_k[1] + 255) - cu_seqlens_k[0])) >> 8) + 1) & 1) * 32768) + 65536)])), (&(acc_output[0])));
  }
  #pragma unroll
...
#endif
    *(uint1*)(((bfloat16_t*)buf_dyn_shmem) + (((((((((((i_45 >> 5) * 8192) + (((i_45 & 3) >> 1) * 4096)) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_45 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((i_45 & 31) >> 4) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_45 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((i_45 & 7) >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 131072)) = __4;
  }
  __syncthreads();
  #pragma unroll
...
extern "C" int call(bfloat16_t* __restrict__ Q, bfloat16_t* __restrict__ K, bfloat16_t* __restrict__ V, int* __restrict__ cu_seqlens_q, int* __restrict__ cu_seqlens_k, int max_seqlen_q, bfloat16_t* __restrict__ O, cudaStream_t stream=cudaStreamDefault) {
	kernel_kernel<<<dim3((max_seqlen_q + 127) / 128, 28, 1), dim3(128, 1, 1), 294912, stream>>>(K, O, Q, V, cu_seqlens_k, cu_seqlens_q, max_seqlen_q);
