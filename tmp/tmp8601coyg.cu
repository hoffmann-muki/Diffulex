...
extern "C" __global__ void __launch_bounds__(256, 1) kernel_kernel(bfloat16_t* __restrict__ K, bfloat16_t* __restrict__ O, bfloat16_t* __restrict__ Q, bfloat16_t* __restrict__ V, int* __restrict__ cu_seqlens_k, int* __restrict__ cu_seqlens_q, int max_seqlen_q) {
  ...
  for (int i = 0; i < 16; ++i) {
    ...
    *(uint2*)(((bfloat16_t*)buf_dyn_shmem) + ((((((((((((int)threadIdx.x) & 31) >> 4) * 8192) + (i * 512)) + ((((int)threadIdx.x) >> 5) * 64)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 1) * 4)) + 65536)) = condval;
  }
  #pragma unroll
  ...
  for (int kv_block_idx = 0; kv_block_idx < (min(((((cu_seqlens_q[1] + 255) - cu_seqlens_q[0]) >> 7) + ((int)blockIdx.x)), (((cu_seqlens_k[1] + 127) - cu_seqlens_k[0]) >> 7)) - 2); ++kv_block_idx) {
    ...
    for (int i_9 = 0; i_9 < 64; ++i_9) {
      float condval_1;
      if (((((((((int)blockIdx.x) * 128) + ((((int)threadIdx.x) >> 6) * 32)) + 32) <= ((((kv_block_idx * 128) + ((i_9 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_9 & 1))) || ((cu_seqlens_q[1] - cu_seqlens_q[0]) <= ((((((int)blockIdx.x) * 128) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_9 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) || ((cu_seqlens_k[1] - cu_seqlens_k[0]) <= ((((kv_block_idx * 128) + ((i_9 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_9 & 1))))) {
    ...
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_ss<128, 128, 128, 8, 1, 0, 1, 0, 128, 128, 0, 0>((&(((bfloat16_t*)buf_dyn_shmem)[65536])), (&(((bfloat16_t*)buf_dyn_shmem)[((kv_block_idx & 1) * 16384)])), (&(acc_score[0])));
    __syncthreads();
    #pragma unroll
    ...
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_rs<128, 128, 128, 8, 1, 0, 0, 0, 128, 128, 0, 0>((&(acc_score_cast[0])), (&(((bfloat16_t*)buf_dyn_shmem)[(((kv_block_idx & 1) * 16384) + 32768)])), (&(acc_output[0])));
    __syncthreads();
    #pragma unroll
  ...
  if ((2 <= ((((cu_seqlens_q[1] + 255) - cu_seqlens_q[0]) >> 7) + ((int)blockIdx.x))) && (129 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_ss<128, 128, 128, 8, 1, 0, 1, 0, 128, 128, 0, 0>((&(((bfloat16_t*)buf_dyn_shmem)[65536])), (&(((bfloat16_t*)buf_dyn_shmem)[((min(((((cu_seqlens_q[1] + 255) - cu_seqlens_q[0]) >> 7) + ((int)blockIdx.x)), (((cu_seqlens_k[1] + 127) - cu_seqlens_k[0]) >> 7)) & 1) * 16384)])), (&(acc_score[0])));
  }
  if ((2 <= ((((cu_seqlens_q[1] + 255) - cu_seqlens_q[0]) >> 7) + ((int)blockIdx.x))) && (129 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    #pragma unroll
  ...
  if ((2 <= ((((cu_seqlens_q[1] + 255) - cu_seqlens_q[0]) >> 7) + ((int)blockIdx.x))) && (129 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_rs<128, 128, 128, 8, 1, 0, 0, 0, 128, 128, 0, 0>((&(acc_score_cast[0])), (&(((bfloat16_t*)buf_dyn_shmem)[(((min(((((cu_seqlens_q[1] + 255) - cu_seqlens_q[0]) >> 7) + ((int)blockIdx.x)), (((cu_seqlens_k[1] + 127) - cu_seqlens_k[0]) >> 7)) & 1) * 16384) + 32768)])), (&(acc_output[0])));
  }
  ...
  if ((1 <= ((((cu_seqlens_q[1] + 255) - cu_seqlens_q[0]) >> 7) + ((int)blockIdx.x))) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_ss<128, 128, 128, 8, 1, 0, 1, 0, 128, 128, 0, 0>((&(((bfloat16_t*)buf_dyn_shmem)[65536])), (&(((bfloat16_t*)buf_dyn_shmem)[(((min(((((cu_seqlens_q[1] + 255) - cu_seqlens_q[0]) >> 7) + ((int)blockIdx.x)), (((cu_seqlens_k[1] + 127) - cu_seqlens_k[0]) >> 7)) + 1) & 1) * 16384)])), (&(acc_score[0])));
  }
  if ((1 <= ((((cu_seqlens_q[1] + 255) - cu_seqlens_q[0]) >> 7) + ((int)blockIdx.x))) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    #pragma unroll
  ...
  if ((1 <= ((((cu_seqlens_q[1] + 255) - cu_seqlens_q[0]) >> 7) + ((int)blockIdx.x))) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_rs<128, 128, 128, 8, 1, 0, 0, 0, 128, 128, 0, 0>((&(acc_score_cast[0])), (&(((bfloat16_t*)buf_dyn_shmem)[((((min(((((cu_seqlens_q[1] + 255) - cu_seqlens_q[0]) >> 7) + ((int)blockIdx.x)), (((cu_seqlens_k[1] + 127) - cu_seqlens_k[0]) >> 7)) + 1) & 1) * 16384) + 32768)])), (&(acc_output[0])));
  }
  #pragma unroll
...
#endif
    *(uint1*)(((bfloat16_t*)buf_dyn_shmem) + ((((((((((i_45 >> 4) * 8192) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_45 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_45 & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_45 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_45 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 65536)) = __4;
  }
  __syncthreads();
  #pragma unroll
...
extern "C" int call(bfloat16_t* __restrict__ Q, bfloat16_t* __restrict__ K, bfloat16_t* __restrict__ V, int* __restrict__ cu_seqlens_q, int* __restrict__ cu_seqlens_k, int max_seqlen_q, bfloat16_t* __restrict__ O, cudaStream_t stream=cudaStreamDefault) {
	kernel_kernel<<<dim3((max_seqlen_q + 127) / 128, 28, 1), dim3(256, 1, 1), 163840, stream>>>(K, O, Q, V, cu_seqlens_k, cu_seqlens_q, max_seqlen_q);
