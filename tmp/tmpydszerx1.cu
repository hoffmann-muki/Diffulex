...
extern "C" __global__ void __launch_bounds__(128, 1) kernel_kernel(bfloat16_t* __restrict__ K, bfloat16_t* __restrict__ O, bfloat16_t* __restrict__ Q, bfloat16_t* __restrict__ V, int* __restrict__ cu_seqlens_k, int* __restrict__ cu_seqlens_q, int max_seqlen_q) {
  ...
  if ((0 < ((((int)blockIdx.x) * 4) + (((cu_seqlens_q[1] + 319) - cu_seqlens_q[0]) >> 6))) && (0 < (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    ...
    for (int i_6 = 0; i_6 < 16; ++i_6) {
      tl::cp_async_gs_conditional<8>(buf_dyn_shmem+((((((((((((int)threadIdx.x) & 31) >> 4) * 8192) + (i_6 * 512)) + ((((int)threadIdx.x) >> 5) * 128)) + (((((((int)threadIdx.x) & 15) >> 3) + (i_6 & 1)) & 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 98304), V+(((((((int64_t)i_6) * (int64_t)2048) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)5) * (int64_t)512)) + (((int64_t)cu_seqlens_k[(int64_t)0]) * (int64_t)512)) + ((((int64_t)((int)blockIdx.y)) / (int64_t)7) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)31) * (int64_t)4)), ((((0 <= (((i_6 * 4) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0])) && ((((i_6 * 4) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) < 64)) && ((((i_6 * 4) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) < 64)) && (0 <= (((i_6 * 4) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]))));
    }
    tl::cp_async_commit();
  }
  if ((1 < ((((int)blockIdx.x) * 4) + (((cu_seqlens_q[1] + 319) - cu_seqlens_q[0]) >> 6))) && (64 < (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    ...
    for (int i_7 = 0; i_7 < 16; ++i_7) {
      tl::cp_async_gs_conditional<8>(buf_dyn_shmem+((((((((((((int)threadIdx.x) & 31) >> 4) * 8192) + (i_7 * 512)) + ((((int)threadIdx.x) >> 5) * 128)) + (((((((int)threadIdx.x) & 15) >> 3) + (i_7 & 1)) & 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 81920), K+((((((((int64_t)i_7) * (int64_t)2048) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)5) * (int64_t)512)) + (((int64_t)cu_seqlens_k[(int64_t)0]) * (int64_t)512)) + ((((int64_t)((int)blockIdx.y)) / (int64_t)7) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)31) * (int64_t)4)) + (int64_t)32768), ((((-64 <= (((i_7 * 4) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0])) && ((((i_7 * 4) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) < 0)) && ((((i_7 * 4) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) < 0)) && (-64 <= (((i_7 * 4) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]))));
    }
    tl::cp_async_commit();
  }
  if ((1 < ((((int)blockIdx.x) * 4) + (((cu_seqlens_q[1] + 319) - cu_seqlens_q[0]) >> 6))) && (64 < (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
  ...
  for (int kv_block_idx = 0; kv_block_idx < (min(((((int)blockIdx.x) * 4) + (((cu_seqlens_q[1] + 319) - cu_seqlens_q[0]) >> 6)), (((cu_seqlens_k[1] + 63) - cu_seqlens_k[0]) >> 6)) - 2); ++kv_block_idx) {
    ...
    for (int i_9 = 0; i_9 < 128; ++i_9) {
      float condval_1;
      if ((((((((((int)blockIdx.x) * 256) + (((i_9 & 15) >> 2) * 64)) + ((((int)threadIdx.x) >> 6) * 32)) + 32) <= ((((kv_block_idx * 64) + ((i_9 >> 4) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_9 & 1))) || ((cu_seqlens_q[1] - cu_seqlens_q[0]) <= (((((((int)blockIdx.x) * 256) + (((i_9 & 15) >> 2) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_9 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) || ((cu_seqlens_k[1] - cu_seqlens_k[0]) <= ((((kv_block_idx * 64) + ((i_9 >> 4) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_9 & 1))))) {
    ...
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_ss<256, 64, 128, 4, 1, 0, 1, 0, 128, 128, 0, 0>((&(((bfloat16_t*)buf_dyn_shmem)[0])), (&(((bfloat16_t*)buf_dyn_shmem)[(((kv_block_idx & 1) * 8192) + 32768)])), (&(acc_score[0])));
    __syncthreads();
    #pragma unroll
    for (int i_10 = 0; i_10 < 16; ++i_10) {
      tl::cp_async_gs_conditional<8>(buf_dyn_shmem+((((((((((kv_block_idx & 1) * 16384) + (((((int)threadIdx.x) & 31) >> 4) * 8192)) + (i_10 * 512)) + ((((int)threadIdx.x) >> 5) * 128)) + (((((((int)threadIdx.x) & 15) >> 3) + (i_10 & 1)) & 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 65536), K+(((((((((int64_t)kv_block_idx) * (int64_t)32768) + (((int64_t)i_10) * (int64_t)2048)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)5) * (int64_t)512)) + (((int64_t)cu_seqlens_k[(int64_t)0]) * (int64_t)512)) + ((((int64_t)((int)blockIdx.y)) / (int64_t)7) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)31) * (int64_t)4)) + (int64_t)65536), ((((-128 <= ((((kv_block_idx * 64) + (i_10 * 4)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0])) && (((((kv_block_idx * 64) + (i_10 * 4)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) < -64)) && (((((kv_block_idx * 64) + (i_10 * 4)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) < -64)) && (-128 <= ((((kv_block_idx * 64) + (i_10 * 4)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]))));
    }
    tl::cp_async_commit();
    #pragma unroll
    ...
    for (int i_13 = 0; i_13 < 8; ++i_13) {
      ...
      for (int rv = 0; rv < 16; ++rv) {
        scores_max[i_13] = max(scores_max[i_13], acc_score[((((rv & 7) * 16) + (i_13 * 2)) + (rv >> 3))]);
      }
    ...
    for (int i_17 = 0; i_17 < 8; ++i_17) {
      ...
      for (int rv_1 = 0; rv_1 < 16; ++rv_1) {
        scores_sum[i_17] = (scores_sum[i_17] + acc_score[((((rv_1 & 7) * 16) + (i_17 * 2)) + (rv_1 >> 3))]);
      }
    ...
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_rs<256, 128, 64, 4, 1, 0, 0, 0, 64, 128, 0, 0>((&(acc_score_cast[0])), (&(((bfloat16_t*)buf_dyn_shmem)[(((kv_block_idx & 1) * 8192) + 49152)])), (&(acc_output[0])));
    __syncthreads();
    #pragma unroll
    for (int i_21 = 0; i_21 < 16; ++i_21) {
      tl::cp_async_gs_conditional<8>(buf_dyn_shmem+((((((((((kv_block_idx & 1) * 16384) + (((((int)threadIdx.x) & 31) >> 4) * 8192)) + (i_21 * 512)) + ((((int)threadIdx.x) >> 5) * 128)) + (((((((int)threadIdx.x) & 15) >> 3) + (i_21 & 1)) & 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 98304), V+(((((((((int64_t)kv_block_idx) * (int64_t)32768) + (((int64_t)i_21) * (int64_t)2048)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)5) * (int64_t)512)) + (((int64_t)cu_seqlens_k[(int64_t)0]) * (int64_t)512)) + ((((int64_t)((int)blockIdx.y)) / (int64_t)7) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)31) * (int64_t)4)) + (int64_t)65536), ((((-128 <= ((((kv_block_idx * 64) + (i_21 * 4)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0])) && (((((kv_block_idx * 64) + (i_21 * 4)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) < -64)) && (((((kv_block_idx * 64) + (i_21 * 4)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) < -64)) && (-128 <= ((((kv_block_idx * 64) + (i_21 * 4)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]))));
    }
    tl::cp_async_commit();
  }
  if ((2 <= ((((int)blockIdx.x) * 4) + (((cu_seqlens_q[1] + 319) - cu_seqlens_q[0]) >> 6))) && (65 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    ...
    for (int i_22 = 0; i_22 < 128; ++i_22) {
      float condval_2;
      if ((((20 <= (((((min(((((int)blockIdx.x) * 4) + (((cu_seqlens_q[1] + 319) - cu_seqlens_q[0]) >> 6)), (((cu_seqlens_k[1] + 63) - cu_seqlens_k[0]) >> 6)) * 8) + (i_22 >> 4)) - ((((int)threadIdx.x) >> 6) * 4)) - (((i_22 & 15) >> 2) * 8)) - (((int)blockIdx.x) * 32))) || ((cu_seqlens_q[1] - cu_seqlens_q[0]) <= (((((((int)blockIdx.x) * 256) + (((i_22 & 15) >> 2) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_22 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) || (((cu_seqlens_k[1] + 128) - cu_seqlens_k[0]) <= ((((min(((((int)blockIdx.x) * 4) + (((cu_seqlens_q[1] + 319) - cu_seqlens_q[0]) >> 6)), (((cu_seqlens_k[1] + 63) - cu_seqlens_k[0]) >> 6)) * 64) + ((i_22 >> 4) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_22 & 1))))) {
  ...
  if ((2 <= ((((int)blockIdx.x) * 4) + (((cu_seqlens_q[1] + 319) - cu_seqlens_q[0]) >> 6))) && (65 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_ss<256, 64, 128, 4, 1, 0, 1, 0, 128, 128, 0, 0>((&(((bfloat16_t*)buf_dyn_shmem)[0])), (&(((bfloat16_t*)buf_dyn_shmem)[(((min(((((int)blockIdx.x) * 4) + (((cu_seqlens_q[1] + 319) - cu_seqlens_q[0]) >> 6)), (((cu_seqlens_k[1] + 63) - cu_seqlens_k[0]) >> 6)) & 1) * 8192) + 32768)])), (&(acc_score[0])));
  }
  if ((2 <= ((((int)blockIdx.x) * 4) + (((cu_seqlens_q[1] + 319) - cu_seqlens_q[0]) >> 6))) && (65 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    #pragma unroll
  ...
  if ((2 <= ((((int)blockIdx.x) * 4) + (((cu_seqlens_q[1] + 319) - cu_seqlens_q[0]) >> 6))) && (65 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    ...
    for (int i_25 = 0; i_25 < 8; ++i_25) {
      ...
      for (int rv_2 = 0; rv_2 < 16; ++rv_2) {
        scores_max[i_25] = max(scores_max[i_25], acc_score[((((rv_2 & 7) * 16) + (i_25 * 2)) + (rv_2 >> 3))]);
      }
  ...
  if ((2 <= ((((int)blockIdx.x) * 4) + (((cu_seqlens_q[1] + 319) - cu_seqlens_q[0]) >> 6))) && (65 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    ...
    for (int i_29 = 0; i_29 < 8; ++i_29) {
      ...
      for (int rv_3 = 0; rv_3 < 16; ++rv_3) {
        scores_sum[i_29] = (scores_sum[i_29] + acc_score[((((rv_3 & 7) * 16) + (i_29 * 2)) + (rv_3 >> 3))]);
      }
  ...
  if ((2 <= ((((int)blockIdx.x) * 4) + (((cu_seqlens_q[1] + 319) - cu_seqlens_q[0]) >> 6))) && (65 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_rs<256, 128, 64, 4, 1, 0, 0, 0, 64, 128, 0, 0>((&(acc_score_cast[0])), (&(((bfloat16_t*)buf_dyn_shmem)[(((min(((((int)blockIdx.x) * 4) + (((cu_seqlens_q[1] + 319) - cu_seqlens_q[0]) >> 6)), (((cu_seqlens_k[1] + 63) - cu_seqlens_k[0]) >> 6)) & 1) * 8192) + 49152)])), (&(acc_output[0])));
  }
  if ((1 <= ((((int)blockIdx.x) * 4) + (((cu_seqlens_q[1] + 319) - cu_seqlens_q[0]) >> 6))) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    #pragma unroll
    for (int i_33 = 0; i_33 < 128; ++i_33) {
      float condval_3;
      if ((((12 <= (((((min(((((int)blockIdx.x) * 4) + (((cu_seqlens_q[1] + 319) - cu_seqlens_q[0]) >> 6)), (((cu_seqlens_k[1] + 63) - cu_seqlens_k[0]) >> 6)) * 8) + (i_33 >> 4)) - ((((int)threadIdx.x) >> 6) * 4)) - (((i_33 & 15) >> 2) * 8)) - (((int)blockIdx.x) * 32))) || ((cu_seqlens_q[1] - cu_seqlens_q[0]) <= (((((((int)blockIdx.x) * 256) + (((i_33 & 15) >> 2) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_33 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) || (((cu_seqlens_k[1] + 64) - cu_seqlens_k[0]) <= ((((min(((((int)blockIdx.x) * 4) + (((cu_seqlens_q[1] + 319) - cu_seqlens_q[0]) >> 6)), (((cu_seqlens_k[1] + 63) - cu_seqlens_k[0]) >> 6)) * 64) + ((i_33 >> 4) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_33 & 1))))) {
  ...
  if ((1 <= ((((int)blockIdx.x) * 4) + (((cu_seqlens_q[1] + 319) - cu_seqlens_q[0]) >> 6))) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_ss<256, 64, 128, 4, 1, 0, 1, 0, 128, 128, 0, 0>((&(((bfloat16_t*)buf_dyn_shmem)[0])), (&(((bfloat16_t*)buf_dyn_shmem)[((((min(((((int)blockIdx.x) * 4) + (((cu_seqlens_q[1] + 319) - cu_seqlens_q[0]) >> 6)), (((cu_seqlens_k[1] + 63) - cu_seqlens_k[0]) >> 6)) + 1) & 1) * 8192) + 32768)])), (&(acc_score[0])));
  }
  if ((1 <= ((((int)blockIdx.x) * 4) + (((cu_seqlens_q[1] + 319) - cu_seqlens_q[0]) >> 6))) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    #pragma unroll
  ...
  if ((1 <= ((((int)blockIdx.x) * 4) + (((cu_seqlens_q[1] + 319) - cu_seqlens_q[0]) >> 6))) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    ...
    for (int i_36 = 0; i_36 < 8; ++i_36) {
      ...
      for (int rv_4 = 0; rv_4 < 16; ++rv_4) {
        scores_max[i_36] = max(scores_max[i_36], acc_score[((((rv_4 & 7) * 16) + (i_36 * 2)) + (rv_4 >> 3))]);
      }
  ...
  if ((1 <= ((((int)blockIdx.x) * 4) + (((cu_seqlens_q[1] + 319) - cu_seqlens_q[0]) >> 6))) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    ...
    for (int i_40 = 0; i_40 < 8; ++i_40) {
      ...
      for (int rv_5 = 0; rv_5 < 16; ++rv_5) {
        scores_sum[i_40] = (scores_sum[i_40] + acc_score[((((rv_5 & 7) * 16) + (i_40 * 2)) + (rv_5 >> 3))]);
      }
  ...
  if ((1 <= ((((int)blockIdx.x) * 4) + (((cu_seqlens_q[1] + 319) - cu_seqlens_q[0]) >> 6))) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_rs<256, 128, 64, 4, 1, 0, 0, 0, 64, 128, 0, 0>((&(acc_score_cast[0])), (&(((bfloat16_t*)buf_dyn_shmem)[((((min(((((int)blockIdx.x) * 4) + (((cu_seqlens_q[1] + 319) - cu_seqlens_q[0]) >> 6)), (((cu_seqlens_k[1] + 63) - cu_seqlens_k[0]) >> 6)) + 1) & 1) * 8192) + 49152)])), (&(acc_output[0])));
  }
  #pragma unroll
...
#endif
    *(uint1*)(((bfloat16_t*)buf_dyn_shmem) + ((((((((((i_45 >> 6) * 16384) + (((i_45 & 7) >> 1) * 4096)) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_45 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((i_45 & 63) >> 5) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_45 & 31) >> 4) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((i_45 & 15) >> 3) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = __4;
  }
  __syncthreads();
  #pragma unroll
...
extern "C" int call(bfloat16_t* __restrict__ Q, bfloat16_t* __restrict__ K, bfloat16_t* __restrict__ V, int* __restrict__ cu_seqlens_q, int* __restrict__ cu_seqlens_k, int max_seqlen_q, bfloat16_t* __restrict__ O, cudaStream_t stream=cudaStreamDefault) {
	kernel_kernel<<<dim3((max_seqlen_q + 255) / 256, 28, 1), dim3(128, 1, 1), 131072, stream>>>(K, O, Q, V, cu_seqlens_k, cu_seqlens_q, max_seqlen_q);
