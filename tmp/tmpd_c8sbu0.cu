...
extern "C" __global__ void __launch_bounds__(128, 1) kernel_kernel(bfloat16_t* __restrict__ K, bfloat16_t* __restrict__ O, bfloat16_t* __restrict__ Q, bfloat16_t* __restrict__ V, int* __restrict__ cu_seqlens_k, int* __restrict__ cu_seqlens_q, int max_seqlen_q) {
  ...
  for (int kv_block_idx = 0; kv_block_idx < ((min(((((((int)blockIdx.x) * 128) + cu_seqlens_q[1]) + 383) - cu_seqlens_q[0]), ((cu_seqlens_k[1] + 255) - cu_seqlens_k[0])) >> 8) - 1); ++kv_block_idx) {
    #pragma unroll
    for (int i_7 = 0; i_7 < 256; ++i_7) {
      float condval_1;
      if ((((((((((int)blockIdx.x) * 128) + (((i_7 & 7) >> 2) * 64)) + ((((int)threadIdx.x) >> 6) * 32)) + 32) <= ((((kv_block_idx * 256) + ((i_7 >> 3) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_7 & 1))) || ((cu_seqlens_q[1] - cu_seqlens_q[0]) <= (((((((int)blockIdx.x) * 128) + (((i_7 & 7) >> 2) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_7 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) || ((cu_seqlens_k[1] - cu_seqlens_k[0]) <= ((((kv_block_idx * 256) + ((i_7 >> 3) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_7 & 1))))) {
  ...
  if ((-127 <= (((((int)blockIdx.x) * 128) + cu_seqlens_q[1]) - cu_seqlens_q[0])) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    ...
    for (int i_20 = 0; i_20 < 256; ++i_20) {
      float condval_2;
      if ((((36 <= ((((((min(((((((int)blockIdx.x) * 128) + cu_seqlens_q[1]) + 383) - cu_seqlens_q[0]), ((cu_seqlens_k[1] + 255) - cu_seqlens_k[0])) >> 8) * 32) + (i_20 >> 3)) - ((((int)threadIdx.x) >> 6) * 4)) - (((i_20 & 7) >> 2) * 8)) - (((int)blockIdx.x) * 16))) || ((cu_seqlens_q[1] - cu_seqlens_q[0]) <= (((((((int)blockIdx.x) * 128) + (((i_20 & 7) >> 2) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_20 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) || (((cu_seqlens_k[1] + 256) - cu_seqlens_k[0]) <= (((((min(((((((int)blockIdx.x) * 128) + cu_seqlens_q[1]) + 383) - cu_seqlens_q[0]), ((cu_seqlens_k[1] + 255) - cu_seqlens_k[0])) >> 8) * 256) + ((i_20 >> 3) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_20 & 1))))) {
...
#endif
    *(uint1*)(((bfloat16_t*)buf_dyn_shmem) + (((((((((((i_32 >> 5) * 8192) + (((i_32 & 3) >> 1) * 4096)) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_32 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((i_32 & 31) >> 4) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_32 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((i_32 & 7) >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 65536)) = __3;
  }
  __syncthreads();
  #pragma unroll
