...
extern "C" __global__ void __launch_bounds__(256, 1) kernel_kernel(bfloat16_t* __restrict__ K, bfloat16_t* __restrict__ O, bfloat16_t* __restrict__ Q, bfloat16_t* __restrict__ V, int* __restrict__ cu_seqlens_k, int* __restrict__ cu_seqlens_q, int max_seqlen_q) {
  ...
  if ((0 < ((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 383) - cu_seqlens_q[0]) >> 7))) && (0 < (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    ...
    for (int i_6 = 0; i_6 < 16; ++i_6) {
      tl::cp_async_gs_conditional<8>(buf_dyn_shmem+((((((((((((int)threadIdx.x) & 31) >> 4) * 16384) + (i_6 * 1024)) + ((((int)threadIdx.x) >> 5) * 128)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 98304), V+(((((((int64_t)i_6) * (int64_t)4096) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)5) * (int64_t)512)) + (((int64_t)cu_seqlens_k[(int64_t)0]) * (int64_t)512)) + ((((int64_t)((int)blockIdx.y)) / (int64_t)7) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)31) * (int64_t)4)), ((((0 <= (((i_6 * 8) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0])) && (((((((int)threadIdx.x) >> 5) + cu_seqlens_k[0]) >> 3) + i_6) < 8)) && (((((((int)threadIdx.x) >> 5) + cu_seqlens_k[0]) >> 3) + i_6) < 8)) && (0 <= (((i_6 * 8) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]))));
    }
    tl::cp_async_commit();
  }
  for (int kv_block_idx = 0; kv_block_idx < (min(((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 383) - cu_seqlens_q[0]) >> 7)), (((cu_seqlens_k[1] + 127) - cu_seqlens_k[0]) >> 7)) - 1); ++kv_block_idx) {
    #pragma unroll
    for (int i_7 = 0; i_7 < 128; ++i_7) {
      float condval_1;
      if ((((((((((int)blockIdx.x) * 256) + (((i_7 & 7) >> 2) * 128)) + ((((int)threadIdx.x) >> 6) * 32)) + 32) <= ((((kv_block_idx * 128) + ((i_7 >> 3) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_7 & 1))) || ((cu_seqlens_q[1] - cu_seqlens_q[0]) <= (((((((int)blockIdx.x) * 256) + (((i_7 & 7) >> 2) * 128)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_7 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) || ((cu_seqlens_k[1] - cu_seqlens_k[0]) <= ((((kv_block_idx * 128) + ((i_7 >> 3) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_7 & 1))))) {
    ...
    tl::cp_async_wait<1>();
    __syncthreads();
    tl::gemm_ss<256, 128, 128, 8, 1, 0, 1, 0, 128, 128, 0, 0>((&(((bfloat16_t*)buf_dyn_shmem)[0])), (&(((bfloat16_t*)buf_dyn_shmem)[32768])), (&(acc_score[0])));
    __syncthreads();
    #pragma unroll
    for (int i_8 = 0; i_8 < 16; ++i_8) {
      tl::cp_async_gs_conditional<8>(buf_dyn_shmem+((((((((((((int)threadIdx.x) & 31) >> 4) * 16384) + (i_8 * 1024)) + ((((int)threadIdx.x) >> 5) * 128)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 65536), K+(((((((((int64_t)kv_block_idx) * (int64_t)65536) + (((int64_t)i_8) * (int64_t)4096)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)5) * (int64_t)512)) + (((int64_t)cu_seqlens_k[(int64_t)0]) * (int64_t)512)) + ((((int64_t)((int)blockIdx.y)) / (int64_t)7) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)31) * (int64_t)4)) + (int64_t)65536), ((((-128 <= ((((kv_block_idx * 128) + (i_8 * 8)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0])) && (((((kv_block_idx * 128) + (i_8 * 8)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) < -64)) && (((((kv_block_idx * 128) + (i_8 * 8)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) < -64)) && (-128 <= ((((kv_block_idx * 128) + (i_8 * 8)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]))));
    }
    tl::cp_async_commit();
    #pragma unroll
    ...
    for (int i_11 = 0; i_11 < 4; ++i_11) {
      ...
      for (int rv = 0; rv < 32; ++rv) {
        scores_max[i_11] = max(scores_max[i_11], acc_score[((((rv & 15) * 8) + (i_11 * 2)) + (rv >> 4))]);
      }
    ...
    for (int i_15 = 0; i_15 < 4; ++i_15) {
      ...
      for (int rv_1 = 0; rv_1 < 32; ++rv_1) {
        scores_sum[i_15] = (scores_sum[i_15] + acc_score[((((rv_1 & 15) * 8) + (i_15 * 2)) + (rv_1 >> 4))]);
      }
    ...
    tl::cp_async_wait<1>();
    __syncthreads();
    tl::gemm_rs<256, 128, 128, 8, 1, 0, 0, 0, 128, 128, 0, 0>((&(acc_score_cast[0])), (&(((bfloat16_t*)buf_dyn_shmem)[49152])), (&(acc_output[0])));
    __syncthreads();
    #pragma unroll
    for (int i_19 = 0; i_19 < 16; ++i_19) {
      tl::cp_async_gs_conditional<8>(buf_dyn_shmem+((((((((((((int)threadIdx.x) & 31) >> 4) * 16384) + (i_19 * 1024)) + ((((int)threadIdx.x) >> 5) * 128)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 98304), V+(((((((((int64_t)kv_block_idx) * (int64_t)65536) + (((int64_t)i_19) * (int64_t)4096)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)5) * (int64_t)512)) + (((int64_t)cu_seqlens_k[(int64_t)0]) * (int64_t)512)) + ((((int64_t)((int)blockIdx.y)) / (int64_t)7) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)31) * (int64_t)4)) + (int64_t)65536), ((((-128 <= ((((kv_block_idx * 128) + (i_19 * 8)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0])) && (((((kv_block_idx * 128) + (i_19 * 8)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) < -64)) && (((((kv_block_idx * 128) + (i_19 * 8)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) < -64)) && (-128 <= ((((kv_block_idx * 128) + (i_19 * 8)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]))));
    }
    tl::cp_async_commit();
  }
  ...
  if ((1 <= ((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 383) - cu_seqlens_q[0]) >> 7))) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    ...
    for (int i_23 = 0; i_23 < 4; ++i_23) {
      ...
      for (int rv_2 = 0; rv_2 < 32; ++rv_2) {
        scores_max[i_23] = max(scores_max[i_23], acc_score[((((rv_2 & 15) * 8) + (i_23 * 2)) + (rv_2 >> 4))]);
      }
  ...
  if ((1 <= ((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 383) - cu_seqlens_q[0]) >> 7))) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    ...
    for (int i_27 = 0; i_27 < 4; ++i_27) {
      ...
      for (int rv_3 = 0; rv_3 < 32; ++rv_3) {
        scores_sum[i_27] = (scores_sum[i_27] + acc_score[((((rv_3 & 15) * 8) + (i_27 * 2)) + (rv_3 >> 4))]);
      }
...
#endif
    *(uint1*)(((bfloat16_t*)buf_dyn_shmem) + ((((((((((i_32 >> 5) * 16384) + (((i_32 & 3) >> 1) * 8192)) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_32 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((i_32 & 31) >> 4) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_32 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((i_32 & 7) >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = __3;
  }
  __syncthreads();
  #pragma unroll
