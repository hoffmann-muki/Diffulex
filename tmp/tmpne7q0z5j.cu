...
extern "C" __global__ void __launch_bounds__(128, 1) kernel_kernel(bfloat16_t* __restrict__ K, bfloat16_t* __restrict__ O, bfloat16_t* __restrict__ Q, bfloat16_t* __restrict__ V, int* __restrict__ cu_seqlens_k, int* __restrict__ cu_seqlens_q, int max_seqlen_q) {
  ...
  for (int i = 0; i < 64; ++i) {
    ...
    *(uint2*)(((bfloat16_t*)buf_dyn_shmem) + ((((((((((((int)threadIdx.x) & 31) >> 4) * 16384) + (i * 256)) + ((((int)threadIdx.x) >> 5) * 64)) + (((((((int)threadIdx.x) & 15) >> 3) + (i & 1)) & 1) * 32)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 1) * 4)) + 65536)) = condval;
  }
  #pragma unroll
  ...
  for (int kv_block_idx = 0; kv_block_idx < (min(((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 383) - cu_seqlens_q[0]) >> 7)), (((cu_seqlens_k[1] + 127) - cu_seqlens_k[0]) >> 7)) - 2); ++kv_block_idx) {
    ...
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_ss<256, 128, 128, 4, 1, 0, 1, 0, 128, 128, 0, 0>((&(((bfloat16_t*)buf_dyn_shmem)[65536])), (&(((bfloat16_t*)buf_dyn_shmem)[((kv_block_idx & 1) * 16384)])), (&(acc_score[0])));
    __syncthreads();
    #pragma unroll
    ...
    for (int i_13 = 0; i_13 < 8; ++i_13) {
      ...
      for (int rv = 0; rv < 32; ++rv) {
        scores_max[i_13] = max(scores_max[i_13], acc_score[((((rv & 15) * 16) + (i_13 * 2)) + (rv >> 4))]);
      }
    ...
    for (int i_17 = 0; i_17 < 8; ++i_17) {
      ...
      for (int rv_1 = 0; rv_1 < 32; ++rv_1) {
        scores_sum[i_17] = (scores_sum[i_17] + acc_score[((((rv_1 & 15) * 16) + (i_17 * 2)) + (rv_1 >> 4))]);
      }
    ...
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_rs<256, 128, 128, 4, 1, 0, 0, 0, 128, 128, 0, 0>((&(acc_score_cast[0])), (&(((bfloat16_t*)buf_dyn_shmem)[(((kv_block_idx & 1) * 16384) + 32768)])), (&(acc_output[0])));
    __syncthreads();
    #pragma unroll
  ...
  if ((2 <= ((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 383) - cu_seqlens_q[0]) >> 7))) && (129 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_ss<256, 128, 128, 4, 1, 0, 1, 0, 128, 128, 0, 0>((&(((bfloat16_t*)buf_dyn_shmem)[65536])), (&(((bfloat16_t*)buf_dyn_shmem)[((min(((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 383) - cu_seqlens_q[0]) >> 7)), (((cu_seqlens_k[1] + 127) - cu_seqlens_k[0]) >> 7)) & 1) * 16384)])), (&(acc_score[0])));
  }
  if ((2 <= ((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 383) - cu_seqlens_q[0]) >> 7))) && (129 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    #pragma unroll
  ...
  if ((2 <= ((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 383) - cu_seqlens_q[0]) >> 7))) && (129 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    ...
    for (int i_25 = 0; i_25 < 8; ++i_25) {
      ...
      for (int rv_2 = 0; rv_2 < 32; ++rv_2) {
        scores_max[i_25] = max(scores_max[i_25], acc_score[((((rv_2 & 15) * 16) + (i_25 * 2)) + (rv_2 >> 4))]);
      }
  ...
  if ((2 <= ((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 383) - cu_seqlens_q[0]) >> 7))) && (129 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    ...
    for (int i_29 = 0; i_29 < 8; ++i_29) {
      ...
      for (int rv_3 = 0; rv_3 < 32; ++rv_3) {
        scores_sum[i_29] = (scores_sum[i_29] + acc_score[((((rv_3 & 15) * 16) + (i_29 * 2)) + (rv_3 >> 4))]);
      }
  ...
  if ((1 <= ((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 383) - cu_seqlens_q[0]) >> 7))) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_ss<256, 128, 128, 4, 1, 0, 1, 0, 128, 128, 0, 0>((&(((bfloat16_t*)buf_dyn_shmem)[65536])), (&(((bfloat16_t*)buf_dyn_shmem)[(((min(((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 383) - cu_seqlens_q[0]) >> 7)), (((cu_seqlens_k[1] + 127) - cu_seqlens_k[0]) >> 7)) + 1) & 1) * 16384)])), (&(acc_score[0])));
  }
  if ((1 <= ((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 383) - cu_seqlens_q[0]) >> 7))) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    #pragma unroll
  ...
  if ((1 <= ((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 383) - cu_seqlens_q[0]) >> 7))) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    ...
    for (int i_36 = 0; i_36 < 8; ++i_36) {
      ...
      for (int rv_4 = 0; rv_4 < 32; ++rv_4) {
        scores_max[i_36] = max(scores_max[i_36], acc_score[((((rv_4 & 15) * 16) + (i_36 * 2)) + (rv_4 >> 4))]);
      }
  ...
  if ((1 <= ((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 383) - cu_seqlens_q[0]) >> 7))) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    ...
    for (int i_40 = 0; i_40 < 8; ++i_40) {
      ...
      for (int rv_5 = 0; rv_5 < 32; ++rv_5) {
        scores_sum[i_40] = (scores_sum[i_40] + acc_score[((((rv_5 & 15) * 16) + (i_40 * 2)) + (rv_5 >> 4))]);
      }
  ...
  if ((1 <= ((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 383) - cu_seqlens_q[0]) >> 7))) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_rs<256, 128, 128, 4, 1, 0, 0, 0, 128, 128, 0, 0>((&(acc_score_cast[0])), (&(((bfloat16_t*)buf_dyn_shmem)[((((min(((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 383) - cu_seqlens_q[0]) >> 7)), (((cu_seqlens_k[1] + 127) - cu_seqlens_k[0]) >> 7)) + 1) & 1) * 16384) + 32768)])), (&(acc_output[0])));
  }
  #pragma unroll
...
#endif
    *(uint1*)(((bfloat16_t*)buf_dyn_shmem) + (((((((((((i_45 >> 6) * 16384) + (((i_45 & 7) >> 1) * 4096)) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_45 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((i_45 & 63) >> 5) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_45 & 31) >> 4) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((i_45 & 15) >> 3) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 65536)) = __4;
  }
  __syncthreads();
  #pragma unroll
...
extern "C" int call(bfloat16_t* __restrict__ Q, bfloat16_t* __restrict__ K, bfloat16_t* __restrict__ V, int* __restrict__ cu_seqlens_q, int* __restrict__ cu_seqlens_k, int max_seqlen_q, bfloat16_t* __restrict__ O, cudaStream_t stream=cudaStreamDefault) {
	kernel_kernel<<<dim3((max_seqlen_q + 255) / 256, 28, 1), dim3(128, 1, 1), 196608, stream>>>(K, O, Q, V, cu_seqlens_k, cu_seqlens_q, max_seqlen_q);
