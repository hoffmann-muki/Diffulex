...
extern "C" __global__ void __launch_bounds__(256, 1) kernel_kernel(bfloat16_t* __restrict__ K, bfloat16_t* __restrict__ O, bfloat16_t* __restrict__ Q, bfloat16_t* __restrict__ V, int* __restrict__ cu_seqlens_k, int* __restrict__ cu_seqlens_q, int max_seqlen_q) {
  ...
  for (int i = 0; i < 16; ++i) {
    ...
    *(uint2*)(((bfloat16_t*)buf_dyn_shmem) + ((((((((((((int)threadIdx.x) & 31) >> 4) * 8192) + (i * 512)) + ((((int)threadIdx.x) >> 5) * 64)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 1) * 4)) + 32768)) = condval;
  }
  #pragma unroll
  ...
  if ((0 < ((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 191) - cu_seqlens_q[0]) >> 6))) && (0 < (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    ...
    for (int i_6 = 0; i_6 < 8; ++i_6) {
      tl::cp_async_gs_conditional<8>(buf_dyn_shmem+((((((((((((int)threadIdx.x) & 31) >> 4) * 8192) + (i_6 * 1024)) + ((((int)threadIdx.x) >> 5) * 128)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 32768), V+(((((((int64_t)i_6) * (int64_t)4096) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)5) * (int64_t)512)) + (((int64_t)cu_seqlens_k[(int64_t)0]) * (int64_t)512)) + ((((int64_t)((int)blockIdx.y)) / (int64_t)7) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)31) * (int64_t)4)), ((((0 <= (((i_6 * 8) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0])) && ((((i_6 * 8) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) < 64)) && ((((i_6 * 8) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) < 64)) && (0 <= (((i_6 * 8) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]))));
    }
    tl::cp_async_commit();
  }
  if ((1 < ((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 191) - cu_seqlens_q[0]) >> 6))) && (64 < (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    ...
    for (int i_7 = 0; i_7 < 8; ++i_7) {
      tl::cp_async_gs_conditional<8>(buf_dyn_shmem+((((((((((((int)threadIdx.x) & 31) >> 4) * 8192) + (i_7 * 1024)) + ((((int)threadIdx.x) >> 5) * 128)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 16384), K+((((((((int64_t)i_7) * (int64_t)4096) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)5) * (int64_t)512)) + (((int64_t)cu_seqlens_k[(int64_t)0]) * (int64_t)512)) + ((((int64_t)((int)blockIdx.y)) / (int64_t)7) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)31) * (int64_t)4)) + (int64_t)32768), ((((-64 <= (((i_7 * 8) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0])) && ((((i_7 * 8) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) < 0)) && ((((i_7 * 8) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) < 0)) && (-64 <= (((i_7 * 8) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]))));
    }
    tl::cp_async_commit();
  }
  if ((1 < ((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 191) - cu_seqlens_q[0]) >> 6))) && (64 < (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    ...
    for (int i_8 = 0; i_8 < 8; ++i_8) {
      tl::cp_async_gs_conditional<8>(buf_dyn_shmem+((((((((((((int)threadIdx.x) & 31) >> 4) * 8192) + (i_8 * 1024)) + ((((int)threadIdx.x) >> 5) * 128)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 49152), V+((((((((int64_t)i_8) * (int64_t)4096) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)5) * (int64_t)512)) + (((int64_t)cu_seqlens_k[(int64_t)0]) * (int64_t)512)) + ((((int64_t)((int)blockIdx.y)) / (int64_t)7) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)31) * (int64_t)4)) + (int64_t)32768), ((((-64 <= (((i_8 * 8) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0])) && ((((i_8 * 8) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) < 0)) && ((((i_8 * 8) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) < 0)) && (-64 <= (((i_8 * 8) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]))));
    }
    tl::cp_async_commit();
  }
  for (int kv_block_idx = 0; kv_block_idx < (min(((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 191) - cu_seqlens_q[0]) >> 6)), (((cu_seqlens_k[1] + 63) - cu_seqlens_k[0]) >> 6)) - 2); ++kv_block_idx) {
    ...
    for (int i_9 = 0; i_9 < 32; ++i_9) {
      float condval_1;
      if (((((((((int)blockIdx.x) * 128) + ((((int)threadIdx.x) >> 6) * 32)) + 32) <= ((((kv_block_idx * 64) + ((i_9 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_9 & 1))) || ((cu_seqlens_q[1] - cu_seqlens_q[0]) <= ((((((int)blockIdx.x) * 128) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_9 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) || ((cu_seqlens_k[1] - cu_seqlens_k[0]) <= ((((kv_block_idx * 64) + ((i_9 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_9 & 1))))) {
    ...
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_ss<128, 64, 128, 8, 1, 0, 1, 0, 128, 128, 0, 0>((&(((bfloat16_t*)buf_dyn_shmem)[32768])), (&(((bfloat16_t*)buf_dyn_shmem)[((kv_block_idx & 1) * 8192)])), (&(acc_score[0])));
    __syncthreads();
    #pragma unroll
    for (int i_10 = 0; i_10 < 8; ++i_10) {
      tl::cp_async_gs_conditional<8>(buf_dyn_shmem+(((((((((kv_block_idx & 1) * 16384) + (((((int)threadIdx.x) & 31) >> 4) * 8192)) + (i_10 * 1024)) + ((((int)threadIdx.x) >> 5) * 128)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + ((((int)threadIdx.x) & 1) * 8)), K+(((((((((int64_t)kv_block_idx) * (int64_t)32768) + (((int64_t)i_10) * (int64_t)4096)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)5) * (int64_t)512)) + (((int64_t)cu_seqlens_k[(int64_t)0]) * (int64_t)512)) + ((((int64_t)((int)blockIdx.y)) / (int64_t)7) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)31) * (int64_t)4)) + (int64_t)65536), ((((-128 <= ((((kv_block_idx * 64) + (i_10 * 8)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0])) && (((((kv_block_idx * 64) + (i_10 * 8)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) < -64)) && (((((kv_block_idx * 64) + (i_10 * 8)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) < -64)) && (-128 <= ((((kv_block_idx * 64) + (i_10 * 8)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]))));
    }
    tl::cp_async_commit();
    #pragma unroll
    ...
    for (int i_13 = 0; i_13 < 2; ++i_13) {
      ...
      for (int rv = 0; rv < 16; ++rv) {
        scores_max[i_13] = max(scores_max[i_13], acc_score[((((rv & 7) * 4) + (i_13 * 2)) + (rv >> 3))]);
      }
    ...
    for (int i_17 = 0; i_17 < 2; ++i_17) {
      ...
      for (int rv_1 = 0; rv_1 < 16; ++rv_1) {
        scores_sum[i_17] = (scores_sum[i_17] + acc_score[((((rv_1 & 7) * 4) + (i_17 * 2)) + (rv_1 >> 3))]);
      }
    ...
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_rs<128, 128, 64, 8, 1, 0, 0, 0, 64, 128, 0, 0>((&(acc_score_cast[0])), (&(((bfloat16_t*)buf_dyn_shmem)[(((kv_block_idx & 1) * 8192) + 16384)])), (&(acc_output[0])));
    __syncthreads();
    #pragma unroll
    for (int i_21 = 0; i_21 < 8; ++i_21) {
      tl::cp_async_gs_conditional<8>(buf_dyn_shmem+((((((((((kv_block_idx & 1) * 16384) + (((((int)threadIdx.x) & 31) >> 4) * 8192)) + (i_21 * 1024)) + ((((int)threadIdx.x) >> 5) * 128)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 32768), V+(((((((((int64_t)kv_block_idx) * (int64_t)32768) + (((int64_t)i_21) * (int64_t)4096)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)5) * (int64_t)512)) + (((int64_t)cu_seqlens_k[(int64_t)0]) * (int64_t)512)) + ((((int64_t)((int)blockIdx.y)) / (int64_t)7) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)31) * (int64_t)4)) + (int64_t)65536), ((((-128 <= ((((kv_block_idx * 64) + (i_21 * 8)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0])) && (((((kv_block_idx * 64) + (i_21 * 8)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) < -64)) && (((((kv_block_idx * 64) + (i_21 * 8)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) < -64)) && (-128 <= ((((kv_block_idx * 64) + (i_21 * 8)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]))));
    }
    tl::cp_async_commit();
  }
  if ((2 <= ((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 191) - cu_seqlens_q[0]) >> 6))) && (65 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    ...
    for (int i_22 = 0; i_22 < 32; ++i_22) {
      float condval_2;
      if ((((20 <= ((((min(((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 191) - cu_seqlens_q[0]) >> 6)), (((cu_seqlens_k[1] + 63) - cu_seqlens_k[0]) >> 6)) * 8) + (i_22 >> 2)) - ((((int)threadIdx.x) >> 6) * 4)) - (((int)blockIdx.x) * 16))) || ((cu_seqlens_q[1] - cu_seqlens_q[0]) <= ((((((int)blockIdx.x) * 128) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_22 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) || (((cu_seqlens_k[1] + 128) - cu_seqlens_k[0]) <= ((((min(((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 191) - cu_seqlens_q[0]) >> 6)), (((cu_seqlens_k[1] + 63) - cu_seqlens_k[0]) >> 6)) * 64) + ((i_22 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_22 & 1))))) {
  ...
  if ((2 <= ((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 191) - cu_seqlens_q[0]) >> 6))) && (65 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_ss<128, 64, 128, 8, 1, 0, 1, 0, 128, 128, 0, 0>((&(((bfloat16_t*)buf_dyn_shmem)[32768])), (&(((bfloat16_t*)buf_dyn_shmem)[((min(((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 191) - cu_seqlens_q[0]) >> 6)), (((cu_seqlens_k[1] + 63) - cu_seqlens_k[0]) >> 6)) & 1) * 8192)])), (&(acc_score[0])));
  }
  if ((2 <= ((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 191) - cu_seqlens_q[0]) >> 6))) && (65 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    #pragma unroll
  ...
  if ((2 <= ((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 191) - cu_seqlens_q[0]) >> 6))) && (65 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    ...
    for (int i_25 = 0; i_25 < 2; ++i_25) {
      ...
      for (int rv_2 = 0; rv_2 < 16; ++rv_2) {
        scores_max[i_25] = max(scores_max[i_25], acc_score[((((rv_2 & 7) * 4) + (i_25 * 2)) + (rv_2 >> 3))]);
      }
  ...
  if ((2 <= ((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 191) - cu_seqlens_q[0]) >> 6))) && (65 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    ...
    for (int i_29 = 0; i_29 < 2; ++i_29) {
      ...
      for (int rv_3 = 0; rv_3 < 16; ++rv_3) {
        scores_sum[i_29] = (scores_sum[i_29] + acc_score[((((rv_3 & 7) * 4) + (i_29 * 2)) + (rv_3 >> 3))]);
      }
  ...
  if ((2 <= ((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 191) - cu_seqlens_q[0]) >> 6))) && (65 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_rs<128, 128, 64, 8, 1, 0, 0, 0, 64, 128, 0, 0>((&(acc_score_cast[0])), (&(((bfloat16_t*)buf_dyn_shmem)[(((min(((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 191) - cu_seqlens_q[0]) >> 6)), (((cu_seqlens_k[1] + 63) - cu_seqlens_k[0]) >> 6)) & 1) * 8192) + 16384)])), (&(acc_output[0])));
  }
  if ((1 <= ((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 191) - cu_seqlens_q[0]) >> 6))) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    #pragma unroll
    for (int i_33 = 0; i_33 < 32; ++i_33) {
      float condval_3;
      if ((((12 <= ((((min(((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 191) - cu_seqlens_q[0]) >> 6)), (((cu_seqlens_k[1] + 63) - cu_seqlens_k[0]) >> 6)) * 8) + (i_33 >> 2)) - ((((int)threadIdx.x) >> 6) * 4)) - (((int)blockIdx.x) * 16))) || ((cu_seqlens_q[1] - cu_seqlens_q[0]) <= ((((((int)blockIdx.x) * 128) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_33 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) || (((cu_seqlens_k[1] + 64) - cu_seqlens_k[0]) <= ((((min(((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 191) - cu_seqlens_q[0]) >> 6)), (((cu_seqlens_k[1] + 63) - cu_seqlens_k[0]) >> 6)) * 64) + ((i_33 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_33 & 1))))) {
  ...
  if ((1 <= ((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 191) - cu_seqlens_q[0]) >> 6))) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_ss<128, 64, 128, 8, 1, 0, 1, 0, 128, 128, 0, 0>((&(((bfloat16_t*)buf_dyn_shmem)[32768])), (&(((bfloat16_t*)buf_dyn_shmem)[(((min(((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 191) - cu_seqlens_q[0]) >> 6)), (((cu_seqlens_k[1] + 63) - cu_seqlens_k[0]) >> 6)) + 1) & 1) * 8192)])), (&(acc_score[0])));
  }
  if ((1 <= ((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 191) - cu_seqlens_q[0]) >> 6))) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    #pragma unroll
  ...
  if ((1 <= ((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 191) - cu_seqlens_q[0]) >> 6))) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    ...
    for (int i_36 = 0; i_36 < 2; ++i_36) {
      ...
      for (int rv_4 = 0; rv_4 < 16; ++rv_4) {
        scores_max[i_36] = max(scores_max[i_36], acc_score[((((rv_4 & 7) * 4) + (i_36 * 2)) + (rv_4 >> 3))]);
      }
  ...
  if ((1 <= ((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 191) - cu_seqlens_q[0]) >> 6))) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    ...
    for (int i_40 = 0; i_40 < 2; ++i_40) {
      ...
      for (int rv_5 = 0; rv_5 < 16; ++rv_5) {
        scores_sum[i_40] = (scores_sum[i_40] + acc_score[((((rv_5 & 7) * 4) + (i_40 * 2)) + (rv_5 >> 3))]);
      }
  ...
  if ((1 <= ((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 191) - cu_seqlens_q[0]) >> 6))) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_rs<128, 128, 64, 8, 1, 0, 0, 0, 64, 128, 0, 0>((&(acc_score_cast[0])), (&(((bfloat16_t*)buf_dyn_shmem)[((((min(((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 191) - cu_seqlens_q[0]) >> 6)), (((cu_seqlens_k[1] + 63) - cu_seqlens_k[0]) >> 6)) + 1) & 1) * 8192) + 16384)])), (&(acc_output[0])));
  }
  #pragma unroll
...
#endif
    *(uint1*)(((bfloat16_t*)buf_dyn_shmem) + ((((((((((i_45 >> 4) * 8192) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_45 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_45 & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_45 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_45 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 32768)) = __4;
  }
  __syncthreads();
  #pragma unroll
