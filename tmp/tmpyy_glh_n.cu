...
extern "C" __global__ void __launch_bounds__(256, 1) kernel_kernel(bfloat16_t* __restrict__ K, bfloat16_t* __restrict__ O, bfloat16_t* __restrict__ Q, bfloat16_t* __restrict__ V, int* __restrict__ cu_seqlens_k, int* __restrict__ cu_seqlens_q, int max_seqlen_q) {
  ...
  for (int i = 0; i < 32; ++i) {
    ...
    *(uint2*)(((bfloat16_t*)buf_dyn_shmem) + ((((((((((((int)threadIdx.x) & 31) >> 4) * 16384) + (i * 512)) + ((((int)threadIdx.x) >> 5) * 64)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 1) * 4)) + 32768)) = condval;
  }
  #pragma unroll
  ...
  for (int kv_block_idx = 0; kv_block_idx < min(((((cu_seqlens_q[1] + 511) - cu_seqlens_q[0]) >> 8) + ((int)blockIdx.x)), (((cu_seqlens_k[1] + 255) - cu_seqlens_k[0]) >> 8)); ++kv_block_idx) {
    __syncthreads();
    #pragma unroll
    for (int i_5 = 0; i_5 < 32; ++i_5) {
      uint2 condval_1;
      if (((((0 <= ((((kv_block_idx * 256) + (i_5 * 8)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0])) && (((kv_block_idx * 4) + ((((i_5 * 8) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) >> 6)) < 1)) && (((kv_block_idx * 4) + ((((i_5 * 8) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) >> 6)) < 1)) && (0 <= ((((kv_block_idx * 256) + (i_5 * 8)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0])))) {
        condval_1 = *(uint2*)(K + ((((((((int64_t)kv_block_idx) * (int64_t)131072) + (((int64_t)i_5) * (int64_t)4096)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)5) * (int64_t)512)) + (((int64_t)cu_seqlens_k[(int64_t)0]) * (int64_t)512)) + ((((int64_t)((int)blockIdx.y)) / (int64_t)7) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)31) * (int64_t)4)));
      } else {
      ...
      *(uint2*)(((bfloat16_t*)buf_dyn_shmem) + ((((((((((((int)threadIdx.x) & 31) >> 4) * 16384) + (i_5 * 512)) + ((((int)threadIdx.x) >> 5) * 64)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 1) * 4)) + 65536)) = condval_1;
    }
    #pragma unroll
    for (int i_6 = 0; i_6 < 256; ++i_6) {
      float condval_2;
      if ((((((((((int)blockIdx.x) * 256) + (((i_6 & 7) >> 2) * 128)) + ((((int)threadIdx.x) >> 6) * 32)) + 32) <= ((((kv_block_idx * 256) + ((i_6 >> 3) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_6 & 1))) || ((cu_seqlens_q[1] - cu_seqlens_q[0]) <= (((((((int)blockIdx.x) * 256) + (((i_6 & 7) >> 2) * 128)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_6 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) || ((cu_seqlens_k[1] - cu_seqlens_k[0]) <= ((((kv_block_idx * 256) + ((i_6 >> 3) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_6 & 1))))) {
    ...
    __syncthreads();
    tl::gemm_ss<256, 256, 128, 8, 1, 0, 1, 0, 128, 128, 0, 0>((&(((bfloat16_t*)buf_dyn_shmem)[32768])), (&(((bfloat16_t*)buf_dyn_shmem)[65536])), (&(acc_score[0])));
    #pragma unroll
    ...
    for (int i_17 = 0; i_17 < 32; ++i_17) {
      uint2 condval_3;
      if (((((0 <= ((((kv_block_idx * 256) + (i_17 * 8)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0])) && (((kv_block_idx * 4) + ((((i_17 * 8) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) >> 6)) < 1)) && (((kv_block_idx * 4) + ((((i_17 * 8) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) >> 6)) < 1)) && (0 <= ((((kv_block_idx * 256) + (i_17 * 8)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0])))) {
        condval_3 = *(uint2*)(V + ((((((((int64_t)kv_block_idx) * (int64_t)131072) + (((int64_t)i_17) * (int64_t)4096)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)5) * (int64_t)512)) + (((int64_t)cu_seqlens_k[(int64_t)0]) * (int64_t)512)) + ((((int64_t)((int)blockIdx.y)) / (int64_t)7) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)31) * (int64_t)4)));
      } else {
      ...
      *(uint2*)(((bfloat16_t*)buf_dyn_shmem) + (((((((((((int)threadIdx.x) & 31) >> 4) * 16384) + (i_17 * 512)) + ((((int)threadIdx.x) >> 5) * 64)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 1) * 4))) = condval_3;
    }
    __syncthreads();
    tl::gemm_rs<256, 128, 256, 8, 1, 0, 0, 0, 256, 128, 0, 0>((&(acc_score_cast[0])), (&(((bfloat16_t*)buf_dyn_shmem)[0])), (&(acc_output[0])));
  }
  #pragma unroll
...
#endif
    *(uint1*)(((bfloat16_t*)buf_dyn_shmem) + (((((((((((i_19 >> 5) * 16384) + (((i_19 & 3) >> 1) * 8192)) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_19 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((i_19 & 31) >> 4) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_19 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((i_19 & 7) >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 65536)) = __2;
  }
  __syncthreads();
  #pragma unroll
