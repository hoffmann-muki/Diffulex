...
extern "C" __global__ void __launch_bounds__(128, 1) kernel_kernel(bfloat16_t* __restrict__ K, bfloat16_t* __restrict__ O, bfloat16_t* __restrict__ Q, bfloat16_t* __restrict__ V, int* __restrict__ cu_seqlens_k, int* __restrict__ cu_seqlens_q, int max_seqlen_q) {
  ...
  for (int i = 0; i < 16; ++i) {
    ...
    *(uint2*)(((bfloat16_t*)buf_dyn_shmem) + ((((((((((((int)threadIdx.x) & 31) >> 4) * 4096) + (i * 256)) + ((((int)threadIdx.x) >> 5) * 64)) + (((((((int)threadIdx.x) & 15) >> 3) + (i & 1)) & 1) * 32)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 1) * 4)) + 32768)) = condval;
  }
  #pragma unroll
  ...
  if ((1 < ((((cu_seqlens_q[1] + 127) - cu_seqlens_q[0]) >> 6) + ((int)blockIdx.x))) && (64 < (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    #pragma unroll
  ...
  for (int kv_block_idx = 0; kv_block_idx < (min(((((cu_seqlens_q[1] + 127) - cu_seqlens_q[0]) >> 6) + ((int)blockIdx.x)), (((cu_seqlens_k[1] + 63) - cu_seqlens_k[0]) >> 6)) - 2); ++kv_block_idx) {
    #pragma unroll
    for (int i_9 = 0; i_9 < 32; ++i_9) {
      float condval_1;
      if (((((((((int)blockIdx.x) * 64) + ((((int)threadIdx.x) >> 6) * 32)) + 32) <= ((((kv_block_idx * 64) + ((i_9 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_9 & 1))) || ((cu_seqlens_q[1] - cu_seqlens_q[0]) <= ((((((int)blockIdx.x) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_9 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) || ((cu_seqlens_k[1] - cu_seqlens_k[0]) <= ((((kv_block_idx * 64) + ((i_9 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_9 & 1))))) {
    ...
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_ss<64, 64, 128, 4, 1, 0, 1, 0, 128, 128, 0, 0>((&(((bfloat16_t*)buf_dyn_shmem)[32768])), (&(((bfloat16_t*)buf_dyn_shmem)[((kv_block_idx & 1) * 8192)])), (&(acc_score[0])));
    __syncthreads();
    #pragma unroll
    ...
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_rs<64, 128, 64, 4, 1, 0, 0, 0, 64, 128, 0, 0>((&(acc_score_cast[0])), (&(((bfloat16_t*)buf_dyn_shmem)[(((kv_block_idx & 1) * 8192) + 16384)])), (&(acc_output[0])));
    __syncthreads();
    #pragma unroll
  ...
  if ((2 <= ((((cu_seqlens_q[1] + 127) - cu_seqlens_q[0]) >> 6) + ((int)blockIdx.x))) && (65 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    #pragma unroll
    for (int i_22 = 0; i_22 < 32; ++i_22) {
      float condval_2;
      if ((((20 <= ((((min(((((cu_seqlens_q[1] + 127) - cu_seqlens_q[0]) >> 6) + ((int)blockIdx.x)), (((cu_seqlens_k[1] + 63) - cu_seqlens_k[0]) >> 6)) * 8) + (i_22 >> 2)) - ((((int)threadIdx.x) >> 6) * 4)) - (((int)blockIdx.x) * 8))) || ((cu_seqlens_q[1] - cu_seqlens_q[0]) <= ((((((int)blockIdx.x) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_22 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) || (((cu_seqlens_k[1] + 128) - cu_seqlens_k[0]) <= ((((min(((((cu_seqlens_q[1] + 127) - cu_seqlens_q[0]) >> 6) + ((int)blockIdx.x)), (((cu_seqlens_k[1] + 63) - cu_seqlens_k[0]) >> 6)) * 64) + ((i_22 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_22 & 1))))) {
  ...
  if ((2 <= ((((cu_seqlens_q[1] + 127) - cu_seqlens_q[0]) >> 6) + ((int)blockIdx.x))) && (65 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_ss<64, 64, 128, 4, 1, 0, 1, 0, 128, 128, 0, 0>((&(((bfloat16_t*)buf_dyn_shmem)[32768])), (&(((bfloat16_t*)buf_dyn_shmem)[((min(((((cu_seqlens_q[1] + 127) - cu_seqlens_q[0]) >> 6) + ((int)blockIdx.x)), (((cu_seqlens_k[1] + 63) - cu_seqlens_k[0]) >> 6)) & 1) * 8192)])), (&(acc_score[0])));
  }
  if ((2 <= ((((cu_seqlens_q[1] + 127) - cu_seqlens_q[0]) >> 6) + ((int)blockIdx.x))) && (65 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    #pragma unroll
  ...
  if ((2 <= ((((cu_seqlens_q[1] + 127) - cu_seqlens_q[0]) >> 6) + ((int)blockIdx.x))) && (65 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_rs<64, 128, 64, 4, 1, 0, 0, 0, 64, 128, 0, 0>((&(acc_score_cast[0])), (&(((bfloat16_t*)buf_dyn_shmem)[(((min(((((cu_seqlens_q[1] + 127) - cu_seqlens_q[0]) >> 6) + ((int)blockIdx.x)), (((cu_seqlens_k[1] + 63) - cu_seqlens_k[0]) >> 6)) & 1) * 8192) + 16384)])), (&(acc_output[0])));
  }
  if ((1 <= ((((cu_seqlens_q[1] + 127) - cu_seqlens_q[0]) >> 6) + ((int)blockIdx.x))) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    #pragma unroll
    for (int i_33 = 0; i_33 < 32; ++i_33) {
      float condval_3;
      if ((((12 <= ((((min(((((cu_seqlens_q[1] + 127) - cu_seqlens_q[0]) >> 6) + ((int)blockIdx.x)), (((cu_seqlens_k[1] + 63) - cu_seqlens_k[0]) >> 6)) * 8) + (i_33 >> 2)) - ((((int)threadIdx.x) >> 6) * 4)) - (((int)blockIdx.x) * 8))) || ((cu_seqlens_q[1] - cu_seqlens_q[0]) <= ((((((int)blockIdx.x) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_33 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) || (((cu_seqlens_k[1] + 64) - cu_seqlens_k[0]) <= ((((min(((((cu_seqlens_q[1] + 127) - cu_seqlens_q[0]) >> 6) + ((int)blockIdx.x)), (((cu_seqlens_k[1] + 63) - cu_seqlens_k[0]) >> 6)) * 64) + ((i_33 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_33 & 1))))) {
  ...
  if ((1 <= ((((cu_seqlens_q[1] + 127) - cu_seqlens_q[0]) >> 6) + ((int)blockIdx.x))) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_ss<64, 64, 128, 4, 1, 0, 1, 0, 128, 128, 0, 0>((&(((bfloat16_t*)buf_dyn_shmem)[32768])), (&(((bfloat16_t*)buf_dyn_shmem)[(((min(((((cu_seqlens_q[1] + 127) - cu_seqlens_q[0]) >> 6) + ((int)blockIdx.x)), (((cu_seqlens_k[1] + 63) - cu_seqlens_k[0]) >> 6)) + 1) & 1) * 8192)])), (&(acc_score[0])));
  }
  if ((1 <= ((((cu_seqlens_q[1] + 127) - cu_seqlens_q[0]) >> 6) + ((int)blockIdx.x))) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    #pragma unroll
  ...
  if ((1 <= ((((cu_seqlens_q[1] + 127) - cu_seqlens_q[0]) >> 6) + ((int)blockIdx.x))) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_rs<64, 128, 64, 4, 1, 0, 0, 0, 64, 128, 0, 0>((&(acc_score_cast[0])), (&(((bfloat16_t*)buf_dyn_shmem)[((((min(((((cu_seqlens_q[1] + 127) - cu_seqlens_q[0]) >> 6) + ((int)blockIdx.x)), (((cu_seqlens_k[1] + 63) - cu_seqlens_k[0]) >> 6)) + 1) & 1) * 8192) + 16384)])), (&(acc_output[0])));
  }
  #pragma unroll
...
#endif
    *(uint1*)(((bfloat16_t*)buf_dyn_shmem) + ((((((((((i_45 >> 4) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_45 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_45 & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_45 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_45 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 32768)) = __4;
  }
  __syncthreads();
  #pragma unroll
  for (int i_46 = 0; i_46 < 64; ++i_46) {
    if (((((int)blockIdx.x) * 64) + i_46) < (cu_seqlens_q[1] - cu_seqlens_q[0])) {
      if (0 <= (((((int)blockIdx.x) * 64) + i_46) + cu_seqlens_q[0])) {
        if ((((i_46 + cu_seqlens_q[0]) >> 6) + ((int)blockIdx.x)) < 1) {
...
extern "C" int init() {
    ...
    cudaError_t result_kernel_kernel = cudaFuncSetAttribute(kernel_kernel, cudaFuncAttributeMaxDynamicSharedMemorySize, 81920);
    if (result_kernel_kernel != CUDA_SUCCESS) {
        snprintf(error_buf, ERROR_BUF_SIZE, "Failed to set the allowed dynamic shared memory size to %d with error: %s", 81920, cudaGetErrorString(result_kernel_kernel));
        return -1;
    }
...
extern "C" int call(bfloat16_t* __restrict__ Q, bfloat16_t* __restrict__ K, bfloat16_t* __restrict__ V, int* __restrict__ cu_seqlens_q, int* __restrict__ cu_seqlens_k, int max_seqlen_q, bfloat16_t* __restrict__ O, cudaStream_t stream=cudaStreamDefault) {
	kernel_kernel<<<dim3((max_seqlen_q + 63) / 64, 28, 1), dim3(128, 1, 1), 81920, stream>>>(K, O, Q, V, cu_seqlens_k, cu_seqlens_q, max_seqlen_q);
