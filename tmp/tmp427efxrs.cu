...
extern "C" __global__ void __launch_bounds__(128, 1) kernel_kernel(bfloat16_t* __restrict__ K, bfloat16_t* __restrict__ O, bfloat16_t* __restrict__ Q, bfloat16_t* __restrict__ V, int* __restrict__ cu_seqlens_k, int* __restrict__ cu_seqlens_q, int max_seqlen_q) {
  ...
  for (int kv_block_idx = 0; kv_block_idx < min(((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 383) - cu_seqlens_q[0]) >> 7)), (((cu_seqlens_k[1] + 127) - cu_seqlens_k[0]) >> 7)); ++kv_block_idx) {
    __syncthreads();
    #pragma unroll
    for (int i_5 = 0; i_5 < 32; ++i_5) {
      uint2 condval_1;
      if (((((0 <= ((((kv_block_idx * 128) + (i_5 * 4)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0])) && (((kv_block_idx * 2) + ((((i_5 * 4) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) >> 6)) < 1)) && (((kv_block_idx * 2) + ((((i_5 * 4) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) >> 6)) < 1)) && (0 <= ((((kv_block_idx * 128) + (i_5 * 4)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0])))) {
        condval_1 = *(uint2*)(K + ((((((((int64_t)kv_block_idx) * (int64_t)65536) + (((int64_t)i_5) * (int64_t)2048)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)5) * (int64_t)512)) + (((int64_t)cu_seqlens_k[(int64_t)0]) * (int64_t)512)) + ((((int64_t)((int)blockIdx.y)) / (int64_t)7) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)31) * (int64_t)4)));
      } else {
      ...
      *(uint2*)(((bfloat16_t*)buf_dyn_shmem) + ((((((((((((int)threadIdx.x) & 31) >> 4) * 8192) + (i_5 * 256)) + ((((int)threadIdx.x) >> 5) * 64)) + (((((((int)threadIdx.x) & 15) >> 3) + (i_5 & 1)) & 1) * 32)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 1) * 4)) + 32768)) = condval_1;
    }
    #pragma unroll
    for (int i_6 = 0; i_6 < 256; ++i_6) {
      float condval_2;
      if ((((((((((int)blockIdx.x) * 256) + (((i_6 & 15) >> 2) * 64)) + ((((int)threadIdx.x) >> 6) * 32)) + 32) <= ((((kv_block_idx * 128) + ((i_6 >> 4) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_6 & 1))) || ((cu_seqlens_q[1] - cu_seqlens_q[0]) <= (((((((int)blockIdx.x) * 256) + (((i_6 & 15) >> 2) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_6 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) || ((cu_seqlens_k[1] - cu_seqlens_k[0]) <= ((((kv_block_idx * 128) + ((i_6 >> 4) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_6 & 1))))) {
    ...
    __syncthreads();
    tl::gemm_ss<256, 128, 128, 4, 1, 0, 1, 0, 128, 128, 0, 0>((&(((bfloat16_t*)buf_dyn_shmem)[0])), (&(((bfloat16_t*)buf_dyn_shmem)[32768])), (&(acc_score[0])));
    #pragma unroll
    ...
    for (int i_9 = 0; i_9 < 8; ++i_9) {
      ...
      for (int rv = 0; rv < 32; ++rv) {
        scores_max[i_9] = max(scores_max[i_9], acc_score[((((rv & 15) * 16) + (i_9 * 2)) + (rv >> 4))]);
      }
    ...
    for (int i_12 = 0; i_12 < 256; ++i_12) {
      acc_score[i_12] = exp2f(((acc_score[i_12] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/) - (scores_max[((i_12 & 15) >> 1)] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/)));
    }
    #pragma unroll
    for (int i_13 = 0; i_13 < 8; ++i_13) {
      ...
      for (int rv_1 = 0; rv_1 < 32; ++rv_1) {
        scores_sum[i_13] = (scores_sum[i_13] + acc_score[((((rv_1 & 15) * 16) + (i_13 * 2)) + (rv_1 >> 4))]);
      }
    ...
    for (int i_15 = 0; i_15 < 128; ++i_15) {
      uint1 __1;
      float2 v_ = *(float2*)(acc_score + (((((i_15 >> 4) * 32) + (((i_15 & 3) >> 1) * 16)) + (((i_15 & 15) >> 2) * 4)) + ((i_15 & 1) * 2)));
#ifdef ENABLE_BF16
    ...
    for (int i_16 = 0; i_16 < 256; ++i_16) {
      acc_output[i_16] = (acc_output[i_16] * scores_max_prev[((i_16 & 15) >> 1)]);
    }
    __syncthreads();
    #pragma unroll
    for (int i_17 = 0; i_17 < 32; ++i_17) {
      uint2 condval_3;
      if (((((0 <= ((((kv_block_idx * 128) + (i_17 * 4)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0])) && (((kv_block_idx * 2) + ((((i_17 * 4) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) >> 6)) < 1)) && (((kv_block_idx * 2) + ((((i_17 * 4) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) >> 6)) < 1)) && (0 <= ((((kv_block_idx * 128) + (i_17 * 4)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0])))) {
        condval_3 = *(uint2*)(V + ((((((((int64_t)kv_block_idx) * (int64_t)65536) + (((int64_t)i_17) * (int64_t)2048)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)5) * (int64_t)512)) + (((int64_t)cu_seqlens_k[(int64_t)0]) * (int64_t)512)) + ((((int64_t)((int)blockIdx.y)) / (int64_t)7) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)31) * (int64_t)4)));
      } else {
      ...
      *(uint2*)(((bfloat16_t*)buf_dyn_shmem) + ((((((((((((int)threadIdx.x) & 31) >> 4) * 8192) + (i_17 * 256)) + ((((int)threadIdx.x) >> 5) * 64)) + (((((((int)threadIdx.x) & 15) >> 3) + (i_17 & 1)) & 1) * 32)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 1) * 4)) + 49152)) = condval_3;
    }
    __syncthreads();
    tl::gemm_rs<256, 128, 128, 4, 1, 0, 0, 0, 128, 128, 0, 0>((&(acc_score_cast[0])), (&(((bfloat16_t*)buf_dyn_shmem)[49152])), (&(acc_output[0])));
  }
  #pragma unroll
  for (int i_18 = 0; i_18 < 256; ++i_18) {
    acc_output[i_18] = (acc_output[i_18] / log_sum[((i_18 & 15) >> 1)]);
  }
  __syncthreads();
  #pragma unroll
...
#endif
    *(uint1*)(((bfloat16_t*)buf_dyn_shmem) + ((((((((((i_19 >> 6) * 16384) + (((i_19 & 7) >> 1) * 4096)) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_19 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((i_19 & 63) >> 5) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_19 & 31) >> 4) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((i_19 & 15) >> 3) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = __2;
  }
  __syncthreads();
  #pragma unroll
  for (int i_20 = 0; i_20 < 256; ++i_20) {
    if (((((int)blockIdx.x) * 256) + i_20) < (cu_seqlens_q[1] - cu_seqlens_q[0])) {
      if (0 <= (((((int)blockIdx.x) * 256) + i_20) + cu_seqlens_q[0])) {
        if (((((int)blockIdx.x) * 4) + ((i_20 + cu_seqlens_q[0]) >> 6)) < 1) {
          O[(((((((int64_t)((int)blockIdx.x)) * (int64_t)917504) + (((int64_t)i_20) * (int64_t)3584)) + (((int64_t)cu_seqlens_q[(int64_t)0]) * (int64_t)3584)) + (((int64_t)((int)blockIdx.y)) * (int64_t)128)) + ((int64_t)((int)threadIdx.x)))] = ((bfloat16_t*)buf_dyn_shmem)[(((((((((int)threadIdx.x) >> 6) * 16384) + (i_20 * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((i_20 & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_20 & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (i_20 & 1)) & 1) * 8)) + (((int)threadIdx.x) & 7))];
        }
      }
    }
  }
