...
extern "C" __global__ void __launch_bounds__(256, 1) kernel_kernel(bfloat16_t* __restrict__ K, bfloat16_t* __restrict__ O, bfloat16_t* __restrict__ Q, bfloat16_t* __restrict__ V, int* __restrict__ cu_seqlens_k, int* __restrict__ cu_seqlens_q, int max_seqlen_q) {
  ...
  for (int kv_block_idx = 0; kv_block_idx < min(((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 191) - cu_seqlens_q[0]) >> 6)), (((cu_seqlens_k[1] + 63) - cu_seqlens_k[0]) >> 6)); ++kv_block_idx) {
    __syncthreads();
    #pragma unroll
    for (int i_5 = 0; i_5 < 8; ++i_5) {
      uint2 condval_1;
      if (((((0 <= ((((kv_block_idx * 64) + (i_5 * 8)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0])) && ((((((i_5 * 8) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) >> 6) + kv_block_idx) < 1)) && ((((((i_5 * 8) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) >> 6) + kv_block_idx) < 1)) && (0 <= ((((kv_block_idx * 64) + (i_5 * 8)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0])))) {
        condval_1 = *(uint2*)(K + ((((((((int64_t)kv_block_idx) * (int64_t)32768) + (((int64_t)i_5) * (int64_t)4096)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)5) * (int64_t)512)) + (((int64_t)cu_seqlens_k[(int64_t)0]) * (int64_t)512)) + ((((int64_t)((int)blockIdx.y)) / (int64_t)7) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)31) * (int64_t)4)));
      } else {
      ...
      *(uint2*)(((bfloat16_t*)buf_dyn_shmem) + ((((((((((((int)threadIdx.x) & 31) >> 4) * 4096) + (i_5 * 512)) + ((((int)threadIdx.x) >> 5) * 64)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 1) * 4)) + 16384)) = condval_1;
    }
    #pragma unroll
    for (int i_6 = 0; i_6 < 32; ++i_6) {
      float condval_2;
      if (((((((((int)blockIdx.x) * 128) + ((((int)threadIdx.x) >> 6) * 32)) + 32) <= ((((kv_block_idx * 64) + ((i_6 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_6 & 1))) || ((cu_seqlens_q[1] - cu_seqlens_q[0]) <= ((((((int)blockIdx.x) * 128) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_6 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) || ((cu_seqlens_k[1] - cu_seqlens_k[0]) <= ((((kv_block_idx * 64) + ((i_6 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_6 & 1))))) {
    ...
    for (int i_9 = 0; i_9 < 2; ++i_9) {
      ...
      for (int rv = 0; rv < 16; ++rv) {
        scores_max[i_9] = max(scores_max[i_9], acc_score[((((rv & 7) * 4) + (i_9 * 2)) + (rv >> 3))]);
      }
    ...
    for (int i_13 = 0; i_13 < 2; ++i_13) {
      ...
      for (int rv_1 = 0; rv_1 < 16; ++rv_1) {
        scores_sum[i_13] = (scores_sum[i_13] + acc_score[((((rv_1 & 7) * 4) + (i_13 * 2)) + (rv_1 >> 3))]);
      }
    ...
    for (int i_17 = 0; i_17 < 8; ++i_17) {
      uint2 condval_3;
      if (((((0 <= ((((kv_block_idx * 64) + (i_17 * 8)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0])) && ((((((i_17 * 8) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) >> 6) + kv_block_idx) < 1)) && ((((((i_17 * 8) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) >> 6) + kv_block_idx) < 1)) && (0 <= ((((kv_block_idx * 64) + (i_17 * 8)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0])))) {
        condval_3 = *(uint2*)(V + ((((((((int64_t)kv_block_idx) * (int64_t)32768) + (((int64_t)i_17) * (int64_t)4096)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)5) * (int64_t)512)) + (((int64_t)cu_seqlens_k[(int64_t)0]) * (int64_t)512)) + ((((int64_t)((int)blockIdx.y)) / (int64_t)7) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)31) * (int64_t)4)));
      } else {
      ...
      *(uint2*)(((bfloat16_t*)buf_dyn_shmem) + ((((((((((((int)threadIdx.x) & 31) >> 4) * 4096) + (i_17 * 512)) + ((((int)threadIdx.x) >> 5) * 64)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 1) * 4)) + 24576)) = condval_3;
    }
    __syncthreads();
...
#endif
    *(uint1*)(((bfloat16_t*)buf_dyn_shmem) + (((((((((i_19 >> 4) * 8192) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_19 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_19 & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_19 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_19 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = __2;
  }
  __syncthreads();
  #pragma unroll
