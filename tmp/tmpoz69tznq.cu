...
extern "C" __global__ void __launch_bounds__(256, 1) kernel_kernel(bfloat16_t* __restrict__ K, bfloat16_t* __restrict__ O, bfloat16_t* __restrict__ Q, bfloat16_t* __restrict__ V, int* __restrict__ cu_seqlens_k, int* __restrict__ cu_seqlens_q, int max_seqlen_q) {
  ...
  for (int i = 0; i < 32; ++i) {
    ...
    *(uint2*)(((bfloat16_t*)buf_dyn_shmem) + ((((((((((((int)threadIdx.x) & 31) >> 4) * 16384) + (i * 512)) + ((((int)threadIdx.x) >> 5) * 64)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 1) * 4)) + 131072)) = condval;
  }
  #pragma unroll
  ...
  for (int kv_block_idx = 0; kv_block_idx < (min(((((cu_seqlens_q[1] + 511) - cu_seqlens_q[0]) >> 8) + ((int)blockIdx.x)), (((cu_seqlens_k[1] + 255) - cu_seqlens_k[0]) >> 8)) - 2); ++kv_block_idx) {
    ...
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_ss<256, 256, 128, 8, 1, 0, 1, 0, 128, 128, 0, 0>((&(((bfloat16_t*)buf_dyn_shmem)[131072])), (&(((bfloat16_t*)buf_dyn_shmem)[((kv_block_idx & 1) * 32768)])), (&(acc_score[0])));
    __syncthreads();
    #pragma unroll
    ...
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_rs<256, 128, 256, 8, 1, 0, 0, 0, 256, 128, 0, 0>((&(acc_score_cast[0])), (&(((bfloat16_t*)buf_dyn_shmem)[(((kv_block_idx & 1) * 32768) + 65536)])), (&(acc_output[0])));
    __syncthreads();
    #pragma unroll
  ...
  if ((2 <= ((((cu_seqlens_q[1] + 511) - cu_seqlens_q[0]) >> 8) + ((int)blockIdx.x))) && (257 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    ...
    for (int i_22 = 0; i_22 < 256; ++i_22) {
      float condval_2;
      if ((((68 <= (((((min(((((cu_seqlens_q[1] + 511) - cu_seqlens_q[0]) >> 8) + ((int)blockIdx.x)), (((cu_seqlens_k[1] + 255) - cu_seqlens_k[0]) >> 8)) * 32) + (i_22 >> 3)) - ((((int)threadIdx.x) >> 6) * 4)) - (((i_22 & 7) >> 2) * 16)) - (((int)blockIdx.x) * 32))) || ((cu_seqlens_q[1] - cu_seqlens_q[0]) <= (((((((int)blockIdx.x) * 256) + (((i_22 & 7) >> 2) * 128)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_22 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) || (((cu_seqlens_k[1] + 512) - cu_seqlens_k[0]) <= ((((min(((((cu_seqlens_q[1] + 511) - cu_seqlens_q[0]) >> 8) + ((int)blockIdx.x)), (((cu_seqlens_k[1] + 255) - cu_seqlens_k[0]) >> 8)) * 256) + ((i_22 >> 3) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_22 & 1))))) {
  ...
  if ((2 <= ((((cu_seqlens_q[1] + 511) - cu_seqlens_q[0]) >> 8) + ((int)blockIdx.x))) && (257 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_ss<256, 256, 128, 8, 1, 0, 1, 0, 128, 128, 0, 0>((&(((bfloat16_t*)buf_dyn_shmem)[131072])), (&(((bfloat16_t*)buf_dyn_shmem)[((min(((((cu_seqlens_q[1] + 511) - cu_seqlens_q[0]) >> 8) + ((int)blockIdx.x)), (((cu_seqlens_k[1] + 255) - cu_seqlens_k[0]) >> 8)) & 1) * 32768)])), (&(acc_score[0])));
  }
  if ((2 <= ((((cu_seqlens_q[1] + 511) - cu_seqlens_q[0]) >> 8) + ((int)blockIdx.x))) && (257 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    #pragma unroll
  ...
  if ((2 <= ((((cu_seqlens_q[1] + 511) - cu_seqlens_q[0]) >> 8) + ((int)blockIdx.x))) && (257 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_rs<256, 128, 256, 8, 1, 0, 0, 0, 256, 128, 0, 0>((&(acc_score_cast[0])), (&(((bfloat16_t*)buf_dyn_shmem)[(((min(((((cu_seqlens_q[1] + 511) - cu_seqlens_q[0]) >> 8) + ((int)blockIdx.x)), (((cu_seqlens_k[1] + 255) - cu_seqlens_k[0]) >> 8)) & 1) * 32768) + 65536)])), (&(acc_output[0])));
  }
  if ((1 <= ((((cu_seqlens_q[1] + 511) - cu_seqlens_q[0]) >> 8) + ((int)blockIdx.x))) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    #pragma unroll
    for (int i_33 = 0; i_33 < 256; ++i_33) {
      float condval_3;
      if ((((36 <= (((((min(((((cu_seqlens_q[1] + 511) - cu_seqlens_q[0]) >> 8) + ((int)blockIdx.x)), (((cu_seqlens_k[1] + 255) - cu_seqlens_k[0]) >> 8)) * 32) + (i_33 >> 3)) - ((((int)threadIdx.x) >> 6) * 4)) - (((i_33 & 7) >> 2) * 16)) - (((int)blockIdx.x) * 32))) || ((cu_seqlens_q[1] - cu_seqlens_q[0]) <= (((((((int)blockIdx.x) * 256) + (((i_33 & 7) >> 2) * 128)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_33 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) || (((cu_seqlens_k[1] + 256) - cu_seqlens_k[0]) <= ((((min(((((cu_seqlens_q[1] + 511) - cu_seqlens_q[0]) >> 8) + ((int)blockIdx.x)), (((cu_seqlens_k[1] + 255) - cu_seqlens_k[0]) >> 8)) * 256) + ((i_33 >> 3) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_33 & 1))))) {
  ...
  if ((1 <= ((((cu_seqlens_q[1] + 511) - cu_seqlens_q[0]) >> 8) + ((int)blockIdx.x))) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_ss<256, 256, 128, 8, 1, 0, 1, 0, 128, 128, 0, 0>((&(((bfloat16_t*)buf_dyn_shmem)[131072])), (&(((bfloat16_t*)buf_dyn_shmem)[(((min(((((cu_seqlens_q[1] + 511) - cu_seqlens_q[0]) >> 8) + ((int)blockIdx.x)), (((cu_seqlens_k[1] + 255) - cu_seqlens_k[0]) >> 8)) + 1) & 1) * 32768)])), (&(acc_score[0])));
  }
  if ((1 <= ((((cu_seqlens_q[1] + 511) - cu_seqlens_q[0]) >> 8) + ((int)blockIdx.x))) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    #pragma unroll
  ...
  if ((1 <= ((((cu_seqlens_q[1] + 511) - cu_seqlens_q[0]) >> 8) + ((int)blockIdx.x))) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    tl::cp_async_wait<3>();
    __syncthreads();
    tl::gemm_rs<256, 128, 256, 8, 1, 0, 0, 0, 256, 128, 0, 0>((&(acc_score_cast[0])), (&(((bfloat16_t*)buf_dyn_shmem)[((((min(((((cu_seqlens_q[1] + 511) - cu_seqlens_q[0]) >> 8) + ((int)blockIdx.x)), (((cu_seqlens_k[1] + 255) - cu_seqlens_k[0]) >> 8)) + 1) & 1) * 32768) + 65536)])), (&(acc_output[0])));
  }
  #pragma unroll
...
#endif
    *(uint1*)(((bfloat16_t*)buf_dyn_shmem) + (((((((((((i_45 >> 5) * 16384) + (((i_45 & 3) >> 1) * 8192)) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_45 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((i_45 & 31) >> 4) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_45 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((i_45 & 7) >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 131072)) = __4;
  }
  __syncthreads();
  #pragma unroll
    ...
    if ((((((int)blockIdx.x) * 256) + (i_46 * 2)) + (((int)threadIdx.x) >> 7)) < (cu_seqlens_q[1] - cu_seqlens_q[0])) {
      if (0 <= ((((((int)blockIdx.x) * 256) + (i_46 * 2)) + (((int)threadIdx.x) >> 7)) + cu_seqlens_q[0])) {
        if (((((int)blockIdx.x) * 4) + ((((i_46 * 2) + (((int)threadIdx.x) >> 7)) + cu_seqlens_q[0]) >> 6)) < 1) {
          O[((((((((int64_t)((int)blockIdx.x)) * (int64_t)917504) + (((int64_t)i_46) * (int64_t)7168)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)7) * (int64_t)3584)) + (((int64_t)cu_seqlens_q[(int64_t)0]) * (int64_t)3584)) + (((int64_t)((int)blockIdx.y)) * (int64_t)128)) + (((int64_t)((int)threadIdx.x)) & (int64_t)127))] = ((bfloat16_t*)buf_dyn_shmem)[((((((((((((int)threadIdx.x) & 127) >> 6) * 16384) + (i_46 * 128)) + ((((int)threadIdx.x) >> 7) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((i_46 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_46 & 1)) & 1) * 16)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 8)) + (((int)threadIdx.x) & 7)) + 131072)];
        }
      }
    }
  }
...
extern "C" int call(bfloat16_t* __restrict__ Q, bfloat16_t* __restrict__ K, bfloat16_t* __restrict__ V, int* __restrict__ cu_seqlens_q, int* __restrict__ cu_seqlens_k, int max_seqlen_q, bfloat16_t* __restrict__ O, cudaStream_t stream=cudaStreamDefault) {
	kernel_kernel<<<dim3((max_seqlen_q + 255) / 256, 28, 1), dim3(256, 1, 1), 327680, stream>>>(K, O, Q, V, cu_seqlens_k, cu_seqlens_q, max_seqlen_q);
