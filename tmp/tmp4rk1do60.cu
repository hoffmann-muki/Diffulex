...
extern "C" __global__ void __launch_bounds__(256, 1) kernel_kernel(bfloat16_t* __restrict__ K, bfloat16_t* __restrict__ O, bfloat16_t* __restrict__ Q, bfloat16_t* __restrict__ V, int* __restrict__ cu_seqlens_k, int* __restrict__ cu_seqlens_q, int max_seqlen_q) {
  ...
  for (int i = 0; i < 16; ++i) {
    ...
    *(uint2*)(((bfloat16_t*)buf_dyn_shmem) + (((((((((((int)threadIdx.x) & 31) >> 4) * 8192) + (i * 512)) + ((((int)threadIdx.x) >> 5) * 64)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 1) * 4))) = condval;
  }
  #pragma unroll
  ...
  if ((0 < ((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 191) - cu_seqlens_q[0]) >> 6))) && (0 < (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    ...
    for (int i_6 = 0; i_6 < 8; ++i_6) {
      tl::cp_async_gs_conditional<8>(buf_dyn_shmem+((((((((((((int)threadIdx.x) & 31) >> 4) * 8192) + (i_6 * 1024)) + ((((int)threadIdx.x) >> 5) * 128)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 49152), V+(((((((int64_t)i_6) * (int64_t)4096) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)5) * (int64_t)512)) + (((int64_t)cu_seqlens_k[(int64_t)0]) * (int64_t)512)) + ((((int64_t)((int)blockIdx.y)) / (int64_t)7) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)31) * (int64_t)4)), ((((0 <= (((i_6 * 8) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0])) && (((((((int)threadIdx.x) >> 5) + cu_seqlens_k[0]) >> 3) + i_6) < 8)) && (((((((int)threadIdx.x) >> 5) + cu_seqlens_k[0]) >> 3) + i_6) < 8)) && (0 <= (((i_6 * 8) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]))));
    }
    tl::cp_async_commit();
  }
  for (int kv_block_idx = 0; kv_block_idx < (min(((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 191) - cu_seqlens_q[0]) >> 6)), (((cu_seqlens_k[1] + 63) - cu_seqlens_k[0]) >> 6)) - 1); ++kv_block_idx) {
    #pragma unroll
    for (int i_7 = 0; i_7 < 32; ++i_7) {
      float condval_1;
      if (((((((((int)blockIdx.x) * 128) + ((((int)threadIdx.x) >> 6) * 32)) + 32) <= ((((kv_block_idx * 64) + ((i_7 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_7 & 1))) || ((cu_seqlens_q[1] - cu_seqlens_q[0]) <= ((((((int)blockIdx.x) * 128) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_7 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) || ((cu_seqlens_k[1] - cu_seqlens_k[0]) <= ((((kv_block_idx * 64) + ((i_7 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_7 & 1))))) {
    ...
    tl::cp_async_wait<1>();
    __syncthreads();
    tl::gemm_ss<128, 64, 128, 8, 1, 0, 1, 0, 128, 128, 0, 0>((&(((bfloat16_t*)buf_dyn_shmem)[0])), (&(((bfloat16_t*)buf_dyn_shmem)[16384])), (&(acc_score[0])));
    __syncthreads();
    #pragma unroll
    for (int i_8 = 0; i_8 < 8; ++i_8) {
      tl::cp_async_gs_conditional<8>(buf_dyn_shmem+((((((((((((int)threadIdx.x) & 31) >> 4) * 8192) + (i_8 * 1024)) + ((((int)threadIdx.x) >> 5) * 128)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 32768), K+(((((((((int64_t)kv_block_idx) * (int64_t)32768) + (((int64_t)i_8) * (int64_t)4096)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)5) * (int64_t)512)) + (((int64_t)cu_seqlens_k[(int64_t)0]) * (int64_t)512)) + ((((int64_t)((int)blockIdx.y)) / (int64_t)7) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)31) * (int64_t)4)) + (int64_t)32768), ((((-64 <= ((((kv_block_idx * 64) + (i_8 * 8)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0])) && (((((kv_block_idx * 64) + (i_8 * 8)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) < 0)) && (((((kv_block_idx * 64) + (i_8 * 8)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) < 0)) && (-64 <= ((((kv_block_idx * 64) + (i_8 * 8)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]))));
    }
    tl::cp_async_commit();
    #pragma unroll
    ...
    tl::cp_async_wait<1>();
    __syncthreads();
    tl::gemm_rs<128, 128, 64, 8, 1, 0, 0, 0, 64, 128, 0, 0>((&(acc_score_cast[0])), (&(((bfloat16_t*)buf_dyn_shmem)[24576])), (&(acc_output[0])));
    __syncthreads();
    #pragma unroll
    for (int i_19 = 0; i_19 < 8; ++i_19) {
      tl::cp_async_gs_conditional<8>(buf_dyn_shmem+((((((((((((int)threadIdx.x) & 31) >> 4) * 8192) + (i_19 * 1024)) + ((((int)threadIdx.x) >> 5) * 128)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 49152), V+(((((((((int64_t)kv_block_idx) * (int64_t)32768) + (((int64_t)i_19) * (int64_t)4096)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)5) * (int64_t)512)) + (((int64_t)cu_seqlens_k[(int64_t)0]) * (int64_t)512)) + ((((int64_t)((int)blockIdx.y)) / (int64_t)7) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)31) * (int64_t)4)) + (int64_t)32768), ((((-64 <= ((((kv_block_idx * 64) + (i_19 * 8)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0])) && (((((kv_block_idx * 64) + (i_19 * 8)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) < 0)) && (((((kv_block_idx * 64) + (i_19 * 8)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]) < 0)) && (-64 <= ((((kv_block_idx * 64) + (i_19 * 8)) + (((int)threadIdx.x) >> 5)) + cu_seqlens_k[0]))));
    }
    tl::cp_async_commit();
  }
  if ((1 <= ((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 191) - cu_seqlens_q[0]) >> 6))) && (1 <= (cu_seqlens_k[1] - cu_seqlens_k[0]))) {
    ...
    for (int i_20 = 0; i_20 < 32; ++i_20) {
      float condval_2;
      if ((((12 <= ((((min(((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 191) - cu_seqlens_q[0]) >> 6)), (((cu_seqlens_k[1] + 63) - cu_seqlens_k[0]) >> 6)) * 8) + (i_20 >> 2)) - ((((int)threadIdx.x) >> 6) * 4)) - (((int)blockIdx.x) * 16))) || ((cu_seqlens_q[1] - cu_seqlens_q[0]) <= ((((((int)blockIdx.x) * 128) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_20 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) || (((cu_seqlens_k[1] + 64) - cu_seqlens_k[0]) <= ((((min(((((int)blockIdx.x) * 2) + (((cu_seqlens_q[1] + 191) - cu_seqlens_q[0]) >> 6)), (((cu_seqlens_k[1] + 63) - cu_seqlens_k[0]) >> 6)) * 64) + ((i_20 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_20 & 1))))) {
...
#endif
    *(uint1*)(((bfloat16_t*)buf_dyn_shmem) + (((((((((i_32 >> 4) * 8192) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_32 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_32 & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_32 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_32 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = __3;
  }
  __syncthreads();
  #pragma unroll
  for (int i_33 = 0; i_33 < 64; ++i_33) {
    if ((((((int)blockIdx.x) * 128) + (i_33 * 2)) + (((int)threadIdx.x) >> 7)) < (cu_seqlens_q[1] - cu_seqlens_q[0])) {
      if (0 <= ((((((int)blockIdx.x) * 128) + (i_33 * 2)) + (((int)threadIdx.x) >> 7)) + cu_seqlens_q[0])) {
        if (((((int)blockIdx.x) * 2) + ((((i_33 * 2) + (((int)threadIdx.x) >> 7)) + cu_seqlens_q[0]) >> 6)) < 1) {
          O[((((((((int64_t)((int)blockIdx.x)) * (int64_t)458752) + (((int64_t)i_33) * (int64_t)7168)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)7) * (int64_t)3584)) + (((int64_t)cu_seqlens_q[(int64_t)0]) * (int64_t)3584)) + (((int64_t)((int)blockIdx.y)) * (int64_t)128)) + (((int64_t)((int)threadIdx.x)) & (int64_t)127))] = ((bfloat16_t*)buf_dyn_shmem)[(((((((((((int)threadIdx.x) & 127) >> 6) * 8192) + (i_33 * 128)) + ((((int)threadIdx.x) >> 7) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((i_33 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_33 & 1)) & 1) * 16)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 8)) + (((int)threadIdx.x) & 7))];
        }
      }
    }
  }
...
extern "C" int init() {
    ...
    cudaError_t result_kernel_kernel = cudaFuncSetAttribute(kernel_kernel, cudaFuncAttributeMaxDynamicSharedMemorySize, 65536);
    if (result_kernel_kernel != CUDA_SUCCESS) {
        snprintf(error_buf, ERROR_BUF_SIZE, "Failed to set the allowed dynamic shared memory size to %d with error: %s", 65536, cudaGetErrorString(result_kernel_kernel));
        return -1;
    }
...
extern "C" int call(bfloat16_t* __restrict__ Q, bfloat16_t* __restrict__ K, bfloat16_t* __restrict__ V, int* __restrict__ cu_seqlens_q, int* __restrict__ cu_seqlens_k, int max_seqlen_q, bfloat16_t* __restrict__ O, cudaStream_t stream=cudaStreamDefault) {
	kernel_kernel<<<dim3((max_seqlen_q + 127) / 128, 28, 1), dim3(256, 1, 1), 65536, stream>>>(K, O, Q, V, cu_seqlens_k, cu_seqlens_q, max_seqlen_q);
