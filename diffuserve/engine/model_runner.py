...
from diffuserve.engine.sequence import SequenceForCausalLM, SequenceForDiffusionLM, SequenceBase
from diffuserve.model.auto_model import AutoModelForDiffusionLM
from diffuserve.layer.sampler import AutoSampler
from diffuserve.utils.checker import CHECK_SLOT_MAPPING
from diffuserve.utils.context import (
...
class ModelRunnerBase(ABC):
    ...
    def __init__(self, config: Config, rank: int, event: Event | List[Event]):
        ...
        self.model = AutoModelForDiffusionLM.from_config(config)
